...
$this->db->where('acc_id', $this->uri->segment(4));
$this->db->update('accessories', $data);
              $catname = $this->db->get_where('mcategory',array('mid'=>$fab->main_category))->row();
        ...
        <div class="row product-info-outer">
          <div class="col-sm-4 col-md-4 col-lg-4 hidden-xs">
            <div class="product-main-image">
              ...
              <img  class="product-zoom" src='<?php echo base_url();?>assets/images/accessories/resized_accessories/resize400_600/<?php echo $pro->thumb;?>' data-zoom-image="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize800_1200/<?php echo $pro->thumb;?>"/></div>
              <div class="product-main-image__zoom"></div>
            </div>
            <div class="product-images-carousel" align="center">
              <ul id="smallGallery">

                <li><a href="#" data-image="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize400_600/<?php echo $pro->thumb;?>" data-zoom-image="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize800_1200/<?php echo $pro->thumb;?>"><img src="<?php echo base_url();?>assets/images/accessories/resized_accessories/small/<?php echo $pro->thumb;?>" alt="" style="max-height: 100px"/></a></li>
                <?php  if($pro->front!='size.jpg' && $pro->front!='back.jpg' && $pro->front!='front.jpg' && $pro->front!='' && $pro->front!=' ') {?>

                <li><a href="#" data-image="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize400_600/<?php echo $pro->front;?>" data-zoom-image="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize800_1200/<?php echo $pro->front;?>"><img src="<?php echo base_url();?>assets/images/accessories/resized_accessories/small/<?php echo $pro->front;?>" alt="" style="max-height: 100px"/></a></li>
                <?php } ?>

                <?php  if($pro->back!='size.jpg' && $pro->back!='back.jpg' && $pro->front!='front.jpg' && $pro->back!='' && $pro->back!=' ') {?>
                <li><a href="#" data-image="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize400_600/<?php echo $pro->back;?>" data-zoom-image="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize800_1200/<?php echo $pro->back;?>"><img src="<?php echo base_url();?>assets/images/accessories/resized_accessories/small/<?php echo $pro->back;?>" alt="" style="max-height: 100px" /></a></li>
                <?php } ?>
          ...
          ?>
          <li><a href="<?php echo base_url();?>Welcome/shop/<?php echo $cat->mid;?>" style="color: #000;">Accessories</a></li>
          ...
          jq(document).ready(function(){
            ...
            jq("#<?php echo $pro->acc_id; ?>").attr("disabled","disabled");
            ...
            <ul id="singleGallery" class="visible-xs">
              <li><img src="<?php echo base_url();?>assets/images/accessories/<?php echo $pro->thumb;?>" alt="" /></li>
              <?php  if($pro->front=='size.jpg' && $pro->front=='back.jpg' && $pro->front=='front.jpg' && $pro->front!='' && $pro->front!=' ') {?>

              <li><img src="<?php echo base_url();?>assets/images/accessories/<?php echo $pro->front;?>" alt="" /></li>
              <?php } if($pro->back=='size.jpg' && $pro->back=='back.jpg' && $pro->front=='front.jpg' && $pro->back!='' && $pro->back!=' ') {?>

              <li><img src="<?php echo base_url();?>assets/images/accessories/<?php echo $pro->back;?>" alt="" /></li>
<?php } ?>
            </ul>
...
<?php
$data = $this->db->get_where('accessories_search',array('product_id'=>$pro->acc_id))->row();
if(!empty($data)){
...
foreach ($all_filter as $value) {
  ...
  {
  $check = $this->db->get_where('filter',array('filter_main_category'=>3,'fid'=>$data->sub_category_id))->row();
    ...
    $size_arr[] = $data->filter_name;
        ...
        //alert(formdata);
          ...
          jq.ajax({
             ...
             url: '<?php echo base_url();?>index.php/Welcome/addtocart_accessories',
 ...
 input[type=radio]#s<?php echo $k; ?> + label:before{
  ...
  background-color:<?php echo $value; ?>
            ...
            <div class="outer">
              ...
              <input type="hidden" name="fabric" value="<?php echo $pro->acc_id;?>" />
...
">
              ...
              ?>
                ...
                <input type="hidden" name="fabric_id" value="<?php echo $pro->acc_id;?>" class="checkbox-group">
            &nbsp; &nbsp;&nbsp;

              <?php echo form_close();
              $wishlist = $this->db->get_where('wishlist',array('p_id'=>$pro->acc_id,'p_name'=>$pro->brand, 'user_id'=>$this->session->userdata("userid")))->num_rows();
...
$pname = preg_replace('/[^A-Za-z0-9 ]/u','', strip_tags($pro->brand));
  ?>
            ...
            <span id="notifyme_section"><br><br><lable class="lb pull-left" >we will let you know when in stock</lable></br>
             ...
             <p id="filter_msg" style="position: absolute;
    margin-left: 21%;
    margin-top: -1%;"><span class="alert alert-danger">Please select one color and size.</span></p>
            ...
            <?php if($wishlist>=1 ){
                ?>
                 <li><a class="overlay_img overlay_img_fill" id="<?php echo $pro->acc_id; ?>_<?php echo $pname; ?>"><span class=" icon icon-favorite"></span  ><span class="added">Added to Wishlist</span></a></li>
 ...
 <?php if($this->session->userdata("userid")==''){
  ...
  <div class="overlay_img" id="<?php echo $pro->acc_id; ?>_<?php echo $pname; ?>"></div>
 ...
 <a href="<?php echo base_url() ?>Welcome/login?url=<?php echo $url; ?>"><li><span class="icon icon-favorite"></span >Add to Wishlist</li></a>
  ...
  <?php
                  ...
                  ?>
                  <li class="overlay_img" id="<?php echo $pro->acc_id; ?>_<?php echo $pname; ?>"><a href="#"><span class="icon icon-favorite"></span  ><span class="added">Add to Wishlist</span></a></li>
...
<br />
<div class="fb-share-button" data-href="<?php echo current_url();?>" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo current_url();?>">Share On Facebook</a></div> -->
...
<div class="flash-message alert alert-success flashalert<?php echo $pro->acc_id; ?>" ><center>Added To Wishlist</center></div>
...
?></div>
    ...
    <section class="content content--fill">
      ...
      <?php //$info = $this->db->get_where('accessories',array('acc_id'=>$this->uri->segment(4)))->row() ?>
          ...
          <div role="tabpanel" class="tab-pane" id="Tab2">
                         ...
                         <?php $review=$this->db->get_where("review",array("p_id"=>$pro->acc_id,"p_name"=>$pro->brand,"status"=>1))->result();
                         if($this->session->userdata("userid")!=""){
                            $review_my=$this->db->get_where("review",array("p_id"=>$pro->acc_id,"p_name"=>$pro->brand,"userid"=>$this->session->userdata('userid')))->result();
                            //print_r($review_my);
                         }

                        $review_count=$this->db->get_where("review",array("p_id"=>$pro->acc_id,"p_name"=>$pro->brand,"status"=>1))->num_rows();
                        ?>
                        ...
                        <?php //$url =  base_url().'Welcome/acc_product/'.$pro->main_category.'/'.$pro->acc_id; ?>
          ...
          <div role="tabpanel" class="tab-pane" id="Tab5">
            ...
            <?php //echo $pro->sizing_guide; ?>
              <img src="<?php echo base_url(); ?>assets/images/accessories/<?php echo $pro->sizing_guide; ?>" class="sizeimg" >
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container">
        ...
        $this->db->where("acc_id!=",$this->uri->segment(4));
        $this->db->limit(10);
        $rela=$this->db->get_where("accessories",array("status"=>'approve',"status_enable"=>'enable'))->result();
        foreach($rela as $rela){
          $catname = $this->db->get_where('mcategory',array('mid'=>$rela->main_category))->row();
        $mcatname = $this->db->get_where('main_categories',array('id'=>$rela->category_for_filter))->row();
        if(!empty($mcatname)){
        $url =  str_replace("--","-",base_url().'accessories/'.$catname->mcat_name.'/'.str_replace(" ", "-",$mcatname->name).'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$rela->brand))).'/'.$rela->acc_id);
       }else{
        $url =  str_replace("--","-",base_url().'accessories/'.$catname->mcat_name.'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$rela->brand))).'/'.$rela->acc_id);
       }
       ?>
          <div class="product-preview-wrapper" align="center">



<div class="sizes-example sizes-example1">
              <a href="<?php echo $url;?>"><img src="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize400_600/<?php echo $rela->thumb;?>" data-lazy="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize400_600/<?php echo $rela->thumb;?>" alt=""/></a>
</div>

              <center><h5><?php echo substr($rela->brand, 0,30);
                          if(strlen($rela->brand)>30){echo '...';}?></h5></center>
                          <center><h5><i class="fa fa-inr"></i> <?php echo $rela->price; ?></h5></center>
...
$review_num=$this->db->get_where("review",array("userid"=>$this->session->userdata("userid"),'p_id'=>$pro->acc_id,'p_name'=>$pro->brand))->row();
?>
...
<input type="hidden" name="pid" value="<?php  echo $pro->acc_id; ?>">
   ...
   k("#notifyme").click(function(){
       ...
       // alert(notifyme);
         k.ajax({
           ...
           data: {"value":notifyme,"pid":<?php echo $pro->acc_id; ?>,"pname":"<?php echo $pro->brand; ?>","type":"accessories"},
           success: function(response){
            console.log(response);
    ...
    k(".rat_text").hide();
        ...
        //alert(rating);
         k.ajax({
           ...
           data: {"value":rating[1],"pid":<?php echo $pro->acc_id; ?>,"pname":"<?php echo $pro->brand; ?>"},
           success: function(response){
...
$rating = $this->db->get_where('rating',array('p_id'=>$pro->acc_id,'p_name'=>$pro->brand));
 ...
 if(!empty($rat_data) and $rat_num>0)
      ...
      $this->db->where('acc_id',$pro->acc_id);
      $this->db->update('accessories',array('overall_rating'=>$rating2));
      //echo $rating;
    }
     else{
      $rating2 =0;
...
<?
    $rating = $this->db->get_where('rating',array('p_id'=>$pro->acc_id,'p_name'=>$pro->brand,'users'=>$this->session->userdata("userid")));
      $rat_data =$rating->row();
 if(!empty($rat_data))
      {
