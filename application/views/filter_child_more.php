...
<div class="product-preview-wrapper">
  ...
  <div class="sizes-example sizes-example1 image" > 
               <a href="<?php echo base_url();?>index.php/Welcome/moreservice_appoinment/<?php echo $fab->id;?>">
                 <?php if($fab->image=='' || $fab->image==' '){ ?> 
               <img src="<?php echo base_url();?>assets/images/accessories/cover.jpg" alt=""/></a>
                <?php } else { ?>
                 <img src="<?php echo base_url();?>assets/images/more_services/<?php echo $fab->image;?>" alt=""/></a>
                <?php } ?>
											...
											<div class="product-preview__info">
												...
												<h2><a href="#">
													...
													<?php echo substr($fab->subcategory, 0,47);
