                            ...
                            <div class="col-lg-9">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>3,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="accessories_search[]" id="<?php echo $f->filter_name;?>" value="<?php echo $f->fcid;?>" <?php if (strpos($filter_check->filter_subcategory_fcid, $f->fcid)!==false) { echo 'checked';}?>>
              ...
              <input type="hidden" name="oldb" value="<?php echo $edit->back;?>" />
               <img class="img img-responsive" src="<?php echo base_url();?>assets/images/accessories/<?php echo $edit->back;?>" />
					   ...
					   echo form_open_multipart("Product/add_accessories",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Add Images </span> </label>
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span>Accessories Cover Image</span> 
                              <!-- The file input field used as target for the file upload widget -->
                              <input type="file" name="fabricc" id="fileupload1">
                              </span> 
