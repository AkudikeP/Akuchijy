                      ...
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
                            ...
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-5  mgbt-xs-10 mgbt-lg-0">
                                  <select id="manufactures_1" name="uni_category">
                         ...
                         <?php 
                            ...
                            <div class="col-lg-9">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>2,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="uniform_search[]" id="<?php echo $f->filter_name;?>" value="<?php echo $f->fcid;?>" <?php if (strpos($filter_check->filter_subcategory_fcid, $f->fcid)!==false) { echo 'checked';}?>>
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Add Image </span> </label>
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span>Change Uniform Image</span> 
                              <!-- The file input field used as target for the file upload widget -->
                              <input type="file" name="uniform_image" id="fileupload1">
                              <input type="hidden" name="oldt" value="<?php echo $edit->uniform_image;?>" />
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/uniform/<?php echo $edit->uniform_image;?>" />
                              </span> 
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group"> <span class="input-group-addon">&#8358; </span>
                                <input type="number" value="<?php echo $edit->price;?>" onChange="this.value = this.value.replace(/,/g, '.');" placeholder="500" id="wholesale_price" name="price" maxlength="4">
                              </div>
                            </div>
                          </div>
                          <!-- form-group -->
					   ...
					   echo form_open_multipart("Product/add_uniform",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Short description </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="sdesc" id="description_short_1" data-rel="ckeditor" rows="1" ></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Add Image </span> </label>
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span>Uniform Cover Image</span> 
                              <input type="file" name="uniform_image" id="fileupload1">
                              </span> 
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group"> <span class="input-group-addon">&#8358; </span>
                                <input type="number" onChange="this.value = this.value.replace(/,/g, '.');" placeholder="500" id="wholesale_price" name="price" maxlength="4">
                              </div>
                            </div>
                          </div>
                          <!-- form-group -->
