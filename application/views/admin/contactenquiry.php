              ...
              <div class="col-md-<?php  if($this->uri->segment(3)){echo 8;}else{echo 12;}?>" id="table">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Enquiries</h3>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
						  ...
						  <td ><?php echo date("d/m/Y",strtotime($user->enq_postdate));?></td>
						  <td ><?php echo $user->enq_fullname;?></td>
                          <td ><?php echo $user->enq_email;?></td>
						  <td></td>
						  <td ><?php echo $user->enq_phone;?></td>
						  <td ><?php echo $user->enq_city;?></td>
						  <td ><?php echo $user->enq_state;?></td>
                          <td>
<!--                          			<button class="btn btn-xs vd_btn vd_bg-red tailor_del" id="<?php echo $user->enq_id;?>" type="button" title="Delete"><i class="fa fa-trash-o"></i></button>-->
                                	<a class='btn btn-xs btn-danger' href="<?php echo base_url();?>index.php/product/enquiry_delete/<?php echo $user->enq_id;?>" title="Delete" onClick="return confirm('Are you sure You want to Delete?')"><i class='fa fa-trash-o'></i></a>
									<a class='btn btn-xs btn-success' href="<?php echo base_url();?>index.php/product/enquiry_details/<?php echo $user->enq_id;?>" title="View"><i class='fa fa-eye'></i></a>
                                </td>
                        </tr>
                        <?php $i++;}?>
