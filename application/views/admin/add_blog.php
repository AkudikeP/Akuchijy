    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit";}else{echo "Add Blog";}?></h1>
              ...
              <div class="col-sm-12 col-md-4 col-lg-12">
                <div class="form-wizard condensed mgbt-xs-20">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tabinfo" data-toggle="tab"> <i class="fa fa-info-circle append-icon"></i> Blog </a></li>                
                  </ul>
                </div>
              </div>
                  ...
                  <?php } ?>
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("blog",array("id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("Product/add_blog/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                           
                          <h3 class="mgtp-15 mgbt-xs-20"> <b class="text-info"><?php echo $edit->heading;?></b> </h3>

                          <div class="form-group">
                            <label for="name_1" class="control-label col-lg-3 required"> 
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}"> Heading </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" value="<?php echo $edit->heading;?>" required placeholder="Heading" name="heading" class="  updateCurrentText " id="name_1" >
                                </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span>Change Cover Image</span> 
                              ...
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/<?php echo $edit->thumb;?>" />
                              </span> 
                          ...
                          <div class="form-group">
                            <label for="wholesale_price" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Published By</span> </label>
                             <!-- <div class="col-lg-2">
                              <div class="input-group">
                            <input type="text" placeholder="Date" id="datepicker-icon">
                            <span class="input-group-addon" id="quantity" value="<?php echo $edit->pby;?>" name="pdate" id="datepicker-icon-trigger" data-datepicker="#datepicker-icon"><i class="fa fa-calendar"></i></span> </div>
                            </div> -->
                            <div class="col-lg-2">
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->pby;?>" placeholder="Published By" id="pby" name="pby">
                              </div>
                            </div>
                          </div>
                          <!-- form-group -->
                          <div class="form-group">
                            <label for="quantity" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Published Date</span> </label>
                            <div class="col-lg-2">
                             <div class="input-group">
                            <input type="text" placeholder="Date" id="datepicker-icon" name="pdate">
                            <span class="input-group-addon" id="datepicker-icon-trigger" value="<?php echo $edit->pdate;?>" data-datepicker="#datepicker-icon"><i class="fa fa-calendar"></i></span> </div>
                            </div>
                          ...
                          <div class="col-md-8" align="center">
                            <div> 
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Update Blog</button> 
                            <a  href="<?php echo base_url();?>index.php/product/add_blog" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            <i class="fa fa-times append-icon"></i> Add New Blog</a> 
                            </div>
                          </div>
					   ...
					   echo form_open_multipart("Product/add_blog",array("class"=>"form-horizontal"));?>
                        
                        
                         
                          <h3 class="mgtp-15 mgbt-xs-20"> Blog Details</h3>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" required placeholder="Heading" name="heading" class="updateCurrentText" id="name_1" >
                                </div>
                                <div class="col-sm-2">
                                </div>
                              </div>
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Add Images </span> </label>
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span>Blog Cover Image</span> 
                              <!-- The file input field used as target for the file upload widget -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group">
                                <input type="text" placeholder="Published By" id="wholesale_price" name="pby" required>
                              </div>
                            </div>
                          </div>
                          <!-- form-group -->
                           <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group">
                            <input type="text" placeholder="Date" id="datepicker-icon">
                            <span class="input-group-addon" id="quantity" name="pdate" id="datepicker-icon-trigger" data-datepicker="#datepicker-icon"><i class="fa fa-calendar"></i></span> </div>
                            </div>
                           <!--  <div class="col-lg-2">
                              <div class="input-group">
                                <input type="date" placeholder="Published Date" id="quantity" name="pdate" required>
                              </div>
                            </div> -->
                          </div>
                            <div class="col-md-7" align="center">
                            <div> 
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add Blog</button> 
