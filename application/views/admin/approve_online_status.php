                ...
                <div class="panel widget panel-bd-left light-widget">
                      ...
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
                            ...
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-5  mgbt-xs-10 mgbt-lg-0">
                                  ...
                                  <input type="number" min="1" name="tax" value="<?php echo $edit->Tax_Class; ?>" required="">
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan <?php if($edit->Subtract_Stock=='Yes'){echo 'not';} ?>">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="number" min="1" id="minquantity" name="minimum" value="<?php echo $edit->Minimum_Quantity; ?>">
													 </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="ldesc"  id="editor1" data-rel="ckeditor" rows="3" ><?php echo $edit->ldesc;?></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                 ...
                 <input type="hidden" class="sizing_guide_yes_no" name="sizing_guide_yes_no" value="" />
                          ...
                          <div class="">
                            ...
                            <a  href="<?php echo base_url();?>index.php/product/online_status_change/<?php echo $edit->id; ?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                           <i class="fa fa-check" aria-hidden="true"></i>
Approve</a><input type="hidden" name="pagename" value="online_status">
                            </div>
                          </div>
                           <?php echo form_close();
                           ?>
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-5  mgbt-xs-10 mgbt-lg-0">
                                  <input type="number" name="tax" min="1" placeholder="in Parcentage" required="">
