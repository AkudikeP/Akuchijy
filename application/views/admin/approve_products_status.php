                ...
                <div class="panel widget panel-bd-left light-widget">
                         ...
                         <!--maincat-->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i> </span>
                                <input type="number" value="<?php echo $edit->price_without_tax;?>" onChange="this.value = this.value.replace(/,/g, '.');" placeholder="500" id="wholesale_price" name="wholesale_price" maxlength="4">
                              </div>
                            </div>
                          </div>
                          <!-- form-group -->
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan <?php if($edit->Subtract_Stock=='Yes'){echo 'not';} ?>">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="number" id="minquantity" min="1" value="<?php echo $edit->Minimum_Quantity; ?>" name="minimum">
													 </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              ...
                              <textarea name="sdesc" rows="3" contenteditable="true"><?php echo $edit->sdesc;?></textarea>
                            </div>
                 ...
                 <input type="hidden" class="sizing_guide_yes_no" name="sizing_guide_yes_no" value="" />
                            ...
                            <i class="fa fa-times append-icon"></i> Add New Product</a>
														<a  href="<?php echo base_url();?>index.php/product/fabrics_status_change/<?php echo $edit->id; ?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
