              ...
              <div class="col-md-<?php  if($this->uri->segment(3)){echo 8;}else{echo 12;}?>" id="table">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> More Service Vendors</h3>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td width="100px;"><?php echo $user->vendor_name;?><br/><?php echo $user->username;?><br/><?php echo $user->email;?><br/><?php echo $user->contact;?></td>
