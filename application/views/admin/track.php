...
<link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
<?php   $res = $this->db->get_where("meta",array('type'=>'track-order'))->row();
//print_r($res);
	...
	?>              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="panel-body table-responsive">
                    ...
                    <input type="hidden" name="type" value="track-order">
									</div>
								</div>
							</div>
		                   <div class="col-md-4">
                          ...
                          <div class="panel widget panel-bd-left light-widget">
                            ...
                            <div  class="panel-body">
                              <div class="tab-content no-bd mgbt-xs-20">
                                ...
                                <?php
                                $contant = $this->db->get_where('trackorder',array('id'=>1))->row();
          					   echo form_open_multipart("Product/trackordercontant",array("class"=>"form-horizontal"));?>


                                   
                                    <h3 class="mgtp-15 mgbt-xs-20">Update Track Order</h3>
                                    <div class="form-group">
                              ...
                              <!-- tab-content -->
                               <div class="col-md-12">
                                      <div>
                                      <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i>Update Track Order</button>
