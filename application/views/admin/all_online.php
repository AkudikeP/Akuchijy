...
<a href="<?php echo base_url(); ?>product/excel_online"><button class="btn btn-primary">Excel</button></a>
<a href="<?php echo base_url(); ?>product/download_pdf_online"><button class="btn btn-primary">Pdf</button></a>

      </div> 
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Available Online Boutique</h3>
                  </div>
                  <div class="panel-body table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td class="center"><?php echo $fab->padddate."&nbsp";?></td>
                           <td class="center"><?php echo '&nbspPOMD-'.$fab->id;?></td>
                          <td width="100px;"><img style="max-width: 50%;" src="<?php echo base_url();?>assets/images/online_boutique/<?php echo $fab->thumb;?>" /></td>
                          ...
                          <td></i><?php  $count = $this->db->query('select sum(`qty`) as qty from `order_items` where `status` != "cancel" and `status` !="return" and `pid`='.$fab->id.' and `pname` Like "'.preg_replace('/[^A-Za-z0-9 ]/u','', strip_tags($fab->brand)).'"')->row()->qty;
            ...
            ?>
                          ...
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/add_online/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a> 
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/online_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/online_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
