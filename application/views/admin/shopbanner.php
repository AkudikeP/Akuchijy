        ...
        <style>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Front Banner";}else{echo "Add Fabric Banner";}?></h1>
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
             ...
             if($this->uri->segment(3)){
              $button_name='update';
               $edit=$this->db->get_where("shopbanner",array("id"=>$this->uri->segment(3)))->row();
               echo form_open_multipart("Product/shopbanner/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"><span>Change Cover Image</span> <div id="image-holder1"> </div>
                              ...
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/shopbanner/<?php echo $edit->shopbanner;?>" id="remove_image1"/>
                              </span> 
             ...
             echo form_open_multipart("Product/shopbanner",array("class"=>"form-horizontal"));?>
