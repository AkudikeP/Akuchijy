          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("more_services_appoinment",array("app_id"=>$this->uri->segment(3)))->row();
             }
               ?>
               <?php
             if($this->uri->segment(3)){
                ...
                echo form_open("product/change_and_submit_more",array('class'=>"contact-form"));
               ...
               // $this->db->update('user_appoinment',array('admin_status'=>'yes')); ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->subcategory;?>" >
                              </div>
                            </div>
                          </div>
                          </div>
                          ...
                          <!--div class="row">
                          <div class="form-group">
                            <label for="quantity" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Price</span> </label>
                            <div class="col-lg-5">
                              <div class="input-group">
                                <input type="text" class=" updateCurrentText " data-rel="tags-input" value="<?php echo $edit->price;?>" >
                              </div>
                            </div>
                          </div>
                          </div-->
                          <input type="hidden" name="id" value="<?php echo $edit->app_id; ?>">
                          <div class="row">
                          <div class="form-group">
                            <label for="quantity1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">User Name</span> </label>
                            <div class="col-lg-5">
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->user_name;?>" >
                              </div>
                            </div>
                          </div>
                          </div>
                           <div class="row">
                          <div class="form-group">
                            <label for="quantity3" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">User Email</span> </label>
                            <div class="col-lg-5">
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->user_email;?>" >
                              </div>
                            </div>
                          </div>
                          </div>
                          <div class="row">
                          <div class="form-group">
                            <label for="quantity4" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">User Landmark</span> </label>
                            <div class="col-lg-5">
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->landmark;?>" >
                              </div>
                            </div>
                          </div>
                          </div>
                          <div class="row">
                          <div class="form-group">
                            <label for="quantity5" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">User Address</span> </label>
                            <div class="col-lg-5">
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->address;?>" >
                              </div>
                            </div>
                          </div>
                          </div>
                          <div class="row">
                          <div class="form-group">
                            <label for="quantity6" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Appoinment Date</span> </label>
                            <div class="col-lg-5">
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->app_date;?>" >
                              </div>
                            </div>
                          </div>
                          </div>
                          <div class="row">
                          <div class="form-group">
                            <label for="quantity6" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Appoinment Time</span> </label>
                            <div class="col-lg-5">
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->app_time;?>" >
                              </div>
                            </div>
                          </div>
                          <div class="">
                            <div>
                            <?php if($edit->status!='view'){ ?>
<button  type="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                         <i class="fa fa-times append-icon"></i> Submit and Approve</button>
                            <?php }else{ ?>
                            <?php } ?>
                            <a  href="<?php echo base_url();?>index.php/product/all_moreservices" class="btn btn-default btn-sm">
