    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Fabric";}else{echo "Add Fabric";}?></h1>
					   ...
					   if($this->uri->segment(3)){
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" value="<?php if(empty($edit->url)){echo preg_replace('/[^A-Za-z0-9 -]/u','', strtolower(strip_tags(str_replace(" ", "-",$edit->title)))); }else{echo $edit->url;} ?>" required placeholder="Title Name" name="url" class="  updateCurrentText " id="name_1" required >
                                </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->quantity;?>" min="1" placeholder="10" id="quantity" name="quantity" maxlength="4" required>
                              </div>
                            </div>
                          </div>
                           <div class="form-group">
                            <label  class="control-label col-lg-3" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Minimum Qantity to buy product* </span></label>
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="text" required="" name="min_quan_to_buy" value="<?php echo $edit->min_quan_to_buy; ?>" >
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan <?php if($edit->Subtract_Stock=='Yes'){echo 'not';} ?>">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="text" id="minquantity" min="0" value="<?php echo $edit->Minimum_Quantity; ?>" name="minimum">
													 </div>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <input type="hidden" name="pname" value="<?php echo $edit->title; ?>">
        ...
        <div class="modal-footer">
          ...
          <a type="button" class="btn btn-default" data-dismiss="modal">Close</a>
					   ...
					   echo form_open_multipart("Product/add_fabric",array("class"=>"form-horizontal")); ?>
                          ...
                          <h3 class="mgtp-15 mgbt-xs-20"> Fabric Details*</h3>
                         ...
                         <!--div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="radio"    value="yes" name="type_feature" id="feature" required="">
                                <label for="feature">Yes</label>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="radio"    value="yes" name="type_special" id="special" required="">
                                <label for="special">Yes</label>
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group">
                             <input type="text" min="1" name="min_quan_to_buy" id="special" required="" placeholder="2" >
                              </div>
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="text" id="minquantity" min="0" name="minimum" >
													 </div>
                          ...
                          <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Short description* </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="sdesc" rows="3" contenteditable="true" required=""></textarea>
                            </div>
                          <!--  <div class="col-lg-1">
                    ...
                    <input type="file" name="sizing_guide" id="fileupload5">
                      ...
                      <div id="tabinfo1" class="tab-pane">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/Excel/import_data"
                         ...
                         <div class="col-md-1"><button type="submit" id="submit" name="import" class="btn vd_btn vd_bg-blue btn-sm">Upload</button></div>
                             <div class="col-md-4">
                         <a href="<?php echo base_url('excel/excelsheet.csv');?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">Download Excel Sheet</a> 
                        </div>
