...
<link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">  
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Add Measurements Image While Customers ordering Stitching</h1>
             </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Add Category Wise Measurements Image</h3>
                  </div>
                  <div class="panel-body table-responsive">
                  	<?php 
					if($this->uri->segment(3))
					{
						$aedit=$this->db->get_where("measurement_image",array("mid"=>$this->uri->segment(3)))->row();
            if(empty($aedit))
            {
                redirect ("Product/measurements_image");
            }
						echo form_open_multipart("Product/add_measure_image/".$this->uri->segment(3),array("class"=>"form-inline"));?>
  ...
  <div class="form-group">
    ...
    <input type="file" name="attr_image"  class="file1" style="display:none" />
     <input type="hidden" name="oldt" value="<?php echo $aedit->measure_image;?>" class="form-control">
  </div>

  
   <button type="submit" name="submit" class="btn btn-info">Update</button>
  <a href="<?php echo base_url();?>index.php/product/measurements_image" class="btn btn-default">Cancel</a>

                      
                      
                    <?php echo form_close();
					}else{
					echo form_open_multipart("Product/add_measure_image/",array("class"=>"form-inline"));?>
                      ...
                      <tbody>
                       ...
                       <?php $i=1;foreach($attr as $attr){?>
                        <tr class="gradeA">
                          ...
                          <td><img src="<?php echo base_url().'assets/images/measure_image/'.$attr->measure_image;?>" height="60px"></td>
                          <td>
                           <a class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/measurements_image/<?php echo $attr->mid;?>"><i class="fa fa-edit"></i></a> 
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                      var sid=thisvari.attr('id');
                                          ...
                                          $.ajax({
                                           type: "POST",
                                           url: '<?php echo base_url();?>index.php/Product/measure_img_del',
                                           data: {mid:sid},
