                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      <thead>
                        <tr>
                          <th>S.No.</th>
                          <th>Service Link Name</th>
                          <th>Service Link Address</th>
                         <th>Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td><?php echo $fab->service_link_name;?></td>
                          <td><?php echo $fab->service_link_address;?></td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/add_service_link/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a> 
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/service_link_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/service_link_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
