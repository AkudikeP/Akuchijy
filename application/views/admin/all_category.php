    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">  
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Listing All Job Category</h1>
             </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Available Job Category</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                         ...
                         <?php $i=1;foreach($cats as $cats){?>
                        <tr class="gradeA">
                          <td class="center"><?php echo $i;?></td>                       
                          <td><?php echo $cats->cat_name;?></td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/addjobcat/<?php echo $cats->cat_id;?>"><i class="fa fa-edit"></i></a> 
                          <button data-toggle="tooltip" title="Delete" class="btn btn-xs vd_btn vd_bg-red del_fabric" id="<?php echo $cats->cat_id;?>" type="button"><i class="fa fa-trash-o"></i></button>
                                </td>
                        </tr>
                        <?php $i++;}?>
...
<script>	
              ...
              $.ajax({
               ...
               url: '<?php echo base_url();?>index.php/product/del_jcat',
               data: {sid:sid},
