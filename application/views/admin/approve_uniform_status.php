...
<?php } ?>
                         ...
                         <?php } ?>
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan <?php if($edit->Subtract_Stock=='Yes'){echo 'not';} ?>">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="number" id="minquantity" min="1" value="<?php echo $edit->Minimum_Quantity;?>" name="minimum" value="">
													 </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea   name="sdesc"  rows="3" ><?php echo $edit->sdesc;?></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                          ...
                          <!-- form-group -->
                           ...
                           <div class="">
                            ...
                            <i class="fa fa-times append-icon"></i> Add New cUniform</a>
                            <a  href="<?php echo base_url();?>index.php/product/uniform_status_change/<?php echo $edit->uniform_id; ?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            <i class="fa fa-check" aria-hidden="true"></i>
 Approve</a><input type="hidden" name="pagename" value="uniform_status">
                            </div>
                          </div>
                           <?php echo form_close();
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="number" id="minquantity" min="1" name="minimum">
													 </div>
