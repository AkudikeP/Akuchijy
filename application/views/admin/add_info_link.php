    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
              <div class="col-sm-12 col-md-4 col-lg-12">
                <div class="form-wizard condensed mgbt-xs-20">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tabinfo" data-toggle="tab"> <i class="fa fa-info-circle append-icon"></i> Link </a></li>                
                  </ul>
                </div>
              </div>
              ...
              $edit=$this->db->get_where("information_link",array("id"=>$this->uri->segment(3)))->row();
               echo form_open_multipart("Product/add_info_link/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                            
                          <h3 class="mgtp-15 mgbt-xs-20"> Details</h3>

                          <div class="form-group">
                            <label for="info_link_name" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Link Name</span> </label>
                            <div class="col-lg-5">
                           
                                <input type="text" placeholder="Copy Right" id="info_link_name" name="info_link_name" required value="<?php echo $edit->info_link_name;?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="Link Address" id="social_link1" name="info_link_address" required value="<?php echo $edit->info_link_address;?>">
             ...
             echo form_open_multipart("Product/add_info_link",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="" id="social_link" name="info_link_name" required>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="" id="social_link1" name="info_link_address" required>
