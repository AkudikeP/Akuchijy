              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>
                    Manage Popup Image</h3>
                  </div>
                  <div class="panel-body table-responsive">
                  	<?php
					
					
					echo form_open_multipart("product/popup_upload/",array("class"=>"form-horizontal"));?>
                      ...
                      <div class="col-sm-3 controls">
                       <span class="btn vd_btn vd_bg-green fileinput-button"><span>Change Image</span>
                    <input type="hidden" name="old_cfile" value="<?php echo $image->image; ?>" multiple>
                    ...
                    <img src="<?php echo base_url(); ?>/adminassets/styles/<?php echo $image->image; ?>" style="max-width:40%;margin: 20px;">
