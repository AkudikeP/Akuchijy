    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
              ...
              $edit=$this->db->get_where("customer_support_link",array("id"=>$this->uri->segment(3)))->row();
               echo form_open_multipart("Product/add_customer_support_link/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                             
                          <h3 class="mgtp-15 mgbt-xs-20"> Details</h3>

                          <div class="form-group">
                            <label for="link_name" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Link Name</span> </label>
                            <div class="col-lg-5">
                             
                                <input type="text" placeholder="Copy Right" id="link_name" name="link_name" required value="<?php echo $edit->link_name;?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="Link Address" id="social_link1" name="link_address" required value="<?php echo $edit->link_address;?>">
             ...
             echo form_open_multipart("Product/add_customer_support_link",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="" id="social_link" name="link_name" required>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="" id="social_link1" name="link_address" required>
