		...
		<script type="text/javascript" src="<?php echo base_url();?>ckfinder/ckfinder.js"></script>
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Contact Us";}else{echo "Contact Us";}?></h1>
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
             <?php   $res = $this->db->get_where("meta",array('type'=>'contact'))->row();
              //print_r($res);
              ...
              <div class="col-sm-2 col-md-4 col-lg-2">
                <div class="form-wizard condensed mgbt-xs-20">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tabinfo" data-toggle="tab"> <i class="fa fa-info-circle append-icon"></i> Contact Us </a></li>
                  </ul>
                </div>
              </div>
              <div class="col-sm-10 col-md-8 col-lg-10 tab-right">
                <div class="panel widget panel-bd-left light-widget">
                  ...
                  <div  class="panel-body">
                    <div class="tab-content no-bd mgbt-xs-20">
                      ...
                      <?php
					   echo form_open_multipart("Product/contactupdate",array("class"=>"form-horizontal"));
						  $contant = $this->db->get('contactus')->row();
							// echo $contant->phone; ?>

                          
                          <h3 class="mgtp-15 mgbt-xs-20">Contact Us</h3>
                         <div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Phone </span></label>
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                                <textarea name="phone" id="editor1" rows="6" cols="60" required=""><?php echo $contant->phone;?></textarea>
                              </div>
                            </div>
                          </div>
                          <center><h4>Consumer & Commercial</h4></center>
							<div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Consumer Account </span></label>
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                            <textarea class="form-control" id="editor2" name="ca" ><?php echo $contant->ca;?></textarea>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                          <div class="vd_radio radio-success">
                                        <textarea class="form-control" id="editor3" name="cr" ><?php echo $contant->cr;?></textarea>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                                    ...
                                                    <div class="col-lg-10">
                                                      <div class="vd_radio radio-success">
                                                    <textarea class="form-control" id="editor4" name="coacc" ><?php echo $contant->coacc;?></textarea>
                                                      </div>
                                                    </div>
                                                  </div>
