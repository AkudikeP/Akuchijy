              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Create Addon</h3>
                  </div>
                  <div class="panel-body table-responsive">
                  
<form action="<?php echo base_url().'product/add_addon_to_attribut'; ?>" method="post">
