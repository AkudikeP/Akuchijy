    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit";}else{echo "Add";}?></h1>
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
              ...
              $edit=$this->db->get_where("service_link",array("id"=>$this->uri->segment(3)))->row();
               echo form_open_multipart("Product/add_service_link/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                             
                          <h3 class="mgtp-15 mgbt-xs-20"> Details</h3>

                          <div class="form-group">
                            <label for="social_link" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Link Name</span> </label>
                            <div class="col-lg-5">
                             
                                <input type="text" placeholder="Copy Right" id="social_link" name="service_link_name" required value="<?php echo $edit->service_link_name;?>">
                            
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="social_link1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Link Address</span> </label>
                            <div class="col-lg-5">
                              
                                <input type="text" placeholder="Link Address" id="social_link1" name="service_link_address" required value="<?php echo $edit->service_link_address;?>">
             ...
             echo form_open_multipart("Product/add_service_link",array("class"=>"form-horizontal"));?>
                        
                        
                          <h3 class="mgtp-15 mgbt-xs-20"> Details</h3>

                          <div class="form-group">
                            <label for="social_link" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Service Link Name</span> </label>
                            <div class="col-lg-5">
                              
                                <input type="text" placeholder="" id="social_link" name="service_link_name" required>
                             
                            </div>
                          </div>

                          <div class="form-group">
                            <label for="social_link1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Service Link Address</span> </label>
                            <div class="col-lg-5">
                            
                                <input type="text" placeholder="" id="social_link1" name="service_link_address" required>
