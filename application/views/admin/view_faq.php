...
<link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">  
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
                        <?php   $res = $this->db->get_where("meta",array('type'=>'faq'))->row();
              //print_r($res);
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/add_faq/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a> 
...
<script>	
              ...
              $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/product/del_faq',
               data: {fid:sid},
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/faq_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/faq_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
