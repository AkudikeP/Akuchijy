...
<style>
    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
              <?php   $res = $this->db->get_where("meta",array('type'=>'shipping'))->row();
              //print_r($res);
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
                    ...
                    <div class="tab-content no-bd mgbt-xs-20">
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("shippingpage_table1",array("id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("Product/table1/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                            
                          <h3>Table1</h3>

                          <div class="form-group">
                            <label for="name_1" class="control-label col-lg-3 required"> 
                            <span title="" data-toggle="tooltip" class="label-tooltip"> Items </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-12">
                                  
                                  <textarea name="shipping"  id="description_1" rows="5" ><?php echo $edit->items; ?></textarea>
                                </div>
                                <div class="col-sm-2">
                                </div>
                              </div>
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Shipping cost per order </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <input type="text" required value="<?php echo $edit->shipping; ?>" placeholder="items" name="item" class="updateCurrentText" id="name_1" >
                            </div>
                          </div>
					   ...
					   echo form_open_multipart("Product/table1",array("class"=>"form-horizontal"));?>
                         ...
                         <h3>Table 1</h3>
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-12">
                                  ...
                                  <textarea name="shipping"  id="description_1" rows="5" ></textarea>
                                </div>
                                <div class="col-sm-2">
                                </div>
                              </div>
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Shipping cost per order </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <input type="text" required placeholder="items" name="item" class="updateCurrentText" id="name_1" >
                            </div>
                          </div>

                          <div class="col-md-7" align="center">
                            <div> 
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add</button> 
                        ...
                        $fab = $this->db->get('shippingpage_table1')->result(); ?>
                      </div>
                      <!-- #tabinfo -->
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          <td align="center"><?php echo $i;?></td>
                           ...
                           <td><?php echo $fab->items;?></td>
                           <td><?php echo $fab->shipping;?></td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/shipping/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a>
             ...
             if($this->uri->segment(4)){
               $edit=$this->db->get_where("shippingpage_table2",array("id"=>$this->uri->segment(4)))->row();
               echo form_open_multipart("Product/table2/".$this->uri->segment(4),array("class"=>"form-horizontal"));?>
                            
                          <h3>Table 2</h3>

                          <div class="form-group">
                            <label for="name_1" class="control-label col-lg-3 required"> 
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}"> Product </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-12">
                                  <input type="text" value="<?php echo $edit->product;?>" required name="product" class="  updateCurrentText " id="name_1" >
                                </div>
                           ...
                           <div class="form-group">
                            <label for="name_1" class="control-label col-lg-3 required"> 
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}"> Estimated delivery time </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-12">
                                  <input type="text" value="<?php echo $edit->estimated;?>" required name="estimated" class="  updateCurrentText " id="name_1" >
                                </div>
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Urgent delivery day </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="urgent"  id="description_1" rows="5" ><?php echo $edit->urgent;?></textarea>
                            </div>
                          </div>
                           <div class="col-md-7" align="center">
                            <div> 
             ...
             echo form_open_multipart("Product/table2",array("class"=>"form-horizontal"));?>
                         ...
                         <h3>Table 2</h3>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-12">
                                  <input type="text" required name="product" class="  updateCurrentText " id="name_1" >
                                </div>
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-12">
                                  <input type="text" required name="estimated" class="  updateCurrentText " id="name_1" >
                                </div>
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Urgent delivery day </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="urgent"  id="description_1" rows="5" ></textarea>
                            </div>
                          </div>
                        ...
                        <?php echo form_close();} $fab = $this->db->get('shippingpage_table2')->result();  ?>
                      </div>
                      <!-- #tabinfo -->
                                  <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          <td align="center"><?php echo $i;?></td>
                          <td><?php echo $fab->product;?></td>
                          <td><?php echo $fab->estimated;?></td>
                          <td><?php echo $fab->urgent;?></td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/shipping/table2/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a>
                          <button data-toggle="tooltip" title="Delete" class="btn btn-xs vd_btn vd_bg-red del_fabrict2" id="<?php echo $fab->id;?>" type="button"><i class="fa fa-trash-o"></i></button>
             ...
             echo form_open_multipart("Product/shipping_h_update",array("class"=>"form-horizontal"));
             $data = $this->db->get_where('shippingpage',array('id'=>1))->row();
             ?>
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Shipping to Indore </span> </label>
                            <div class="col-lg-10 mgbt-xs-10 mgbt-lg-0">
                            <input type="text" required="" name="h1" value="<?php echo $data->h1; ?>">
                           ...
                           <div class="form-group">
                            ...
                            <textarea required="" name="t1"><?php echo $data->t1; ?></textarea>
                            </div>
                          </div>
<br>
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Delivery time </span> </label>
                            <div class="col-lg-10 mgbt-xs-10 mgbt-lg-0">
                            <input type="text" required="" name="h2" value="<?php echo $data->h2; ?>">
                            </div>
                          </div>
                             <div class="form-group">
                            ...
                            <textarea required="" name="t2"><?php echo $data->t2; ?></textarea>
                            </div>
                          </div><br>
                           <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Estimated delivery time to indore </span> </label>
                            <div class="col-lg-10 mgbt-xs-10 mgbt-lg-0">
                            <input type="text" required="" name="h3" value="<?php echo $data->h3; ?>">
                            </div>
                          </div>
                             <div class="form-group">
                            ...
                            <textarea required="" name="t3"><?php echo $data->t3; ?></textarea>
                            </div>
                          </div><br>

                           <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail.">Shipping Methods</span> </label>
                            <div class="col-lg-10 mgbt-xs-10 mgbt-lg-0">
                            <input type="text" required="" name="h4" value="<?php echo $data->h4; ?>">
                            </div>
                          </div>
                            <div class="form-group">
                            ...
                            <textarea required="" name="t4"><?php echo $data->t4; ?></textarea>
                            </div>
                          </div><br>
                         
                         <h3>Table Titles</h3>
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail.">Items</span> </label>
                            <div class="col-lg-10 mgbt-xs-10 mgbt-lg-0">
                            <input type="text" required="" name="tt1" value="<?php echo $data->tt1; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail.">Shipping cost per order
</span> </label>
                            <div class="col-lg-10 mgbt-xs-10 mgbt-lg-0">
                            <input type="text" required="" name="tt2" value="<?php echo $data->tt2; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail.">Product</span> </label>
                            <div class="col-lg-10 mgbt-xs-10 mgbt-lg-0">
                            <input type="text" required="" name="tt3" value="<?php echo $data->tt3; ?>">
                            </div>
                          </div>
                           <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail.">Estimated delivery time</span> </label>
                            <div class="col-lg-10 mgbt-xs-10 mgbt-lg-0">
                            <input type="text" required="" name="tt4" value="<?php echo $data->tt4; ?>">
                            </div>
                          </div>
                           <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail.">Urgent delivery day</span> </label>
                            <div class="col-lg-10 mgbt-xs-10 mgbt-lg-0">
                            <input type="text" required="" name="tt5" value="<?php echo $data->tt5; ?>">
                            </div>
                          </div>
...
<link rel="stylesheet" href="<?php echo base_url();?>adminassets/css/bundled.css">
    ...
    <script>
          $(document).ready(function(){
              ...
              $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/product/table1_del',
               data: {fid:sid},
              ...
              $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/product/table2_del',
               data: {fid:sid},
               success: function(response){
                 //console.log(response);
               }
