              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Uniform Banner</h3>
                  </div>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td width="50%;"><img style="max-width: 50%;" src="<?php echo base_url();?>assets/images/uniformbanner/<?php echo $ban->banner_image;?>" /></td>
                      
                        <td> 
                          <a class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit" href="<?php echo base_url();?>index.php/product/uniform_banner/<?php echo $ban->id;?>"><i class="fa fa-edit"></i></a> 
                          <button data-toggle="tooltip" title="Delete" class="btn btn-xs vd_btn vd_bg-red del_uniformbanner" id="<?php echo $ban->id;?>" type="button"><i class="fa fa-trash-o"></i></button>
                           <?php if($ban->status=='enable'){
                              echo"<button data-toggle='tooltip' title='Enable' class='btn btn-xs btn-success services_disable' id='$ban->id'><i class='fa fa-lightbulb-o'></i></button>";
                              }else{
                                echo "<button data-toggle='tooltip' title='Disable' class='btn btn-xs btn-danger services_enable' id='$ban->id'><i class='fa fa-lightbulb-o'></i></button>";
                                } ?>
                                </td>
...
<script>	
					$(document).ready(function(){ 
					                     ...
					                     $(".del_uniformbanner").click(function(){
    var thisvari = $(this);
     $.confirm({
                            title: 'Confirmation',
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                      var sid=thisvari.attr('id');
                                          ...
                                          $.ajax({
                                           type: "POST",
                                           url: '<?php echo base_url();?>index.php/Product/del_uniformbanner',
                                           data: {uid:sid},
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/uniformbanner_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/uniformbanner_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
