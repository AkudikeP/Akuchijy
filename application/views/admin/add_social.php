    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Social";}else{echo "Add Social";}?></h1>
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
              <div class="col-sm-12 col-md-4 col-lg-12">
                <div class="form-wizard condensed mgbt-xs-20">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tabinfo" data-toggle="tab"> <i class="fa fa-info-circle append-icon"></i> Social Link </a></li>                
                  </ul>
                </div>
              </div>
              ...
              $edit=$this->db->get_where("social",array("id"=>$this->uri->segment(3)))->row();
               echo form_open_multipart("Product/manage_social/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                            
                          <h3 class="mgtp-15 mgbt-xs-20"> Social Details</h3>

                          <div class="form-group">
                            <label for="name_1" class="control-label col-lg-3 required"> 
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}"> Select Category </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <select id="manufactures_1" name="category" required>
                                  <option value="">Select Category</option>
                                    <option value="Linkdin" <?php if($edit->category=='Linkdin'){echo "selected";}?>>Linkdin</option>
                                    <option value="Facebook" <?php if($edit->category=='Facebook'){echo "selected";}?>>Facebook</option>
                                    <option value="Twitter" <?php if($edit->category=='Twitter'){echo "selected";}?>>Twitter</option>
                                    <option value="Google" <?php if($edit->category=='Google'){echo "selected";}?>>Google</option>
                                    <option value="Pinterest" <?php if($edit->category=='Pinterest'){echo "selected";}?>>Pinterest</option>
                                    <option value="Gmail" <?php if($edit->category=='Gmail'){echo "selected";}?>>Gmail</option>
                          ...
                          <div class="form-group">
                            <label for="social_link" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Social Link</span> </label>
                            <div class="col-lg-9">
                              <div class="input-group">
                                <input type="text" placeholder="Copy Right" id="social_link" name="social_link" required value="<?php echo $edit->social_link;?>">
                              </div>
                            </div>
                          </div>
                           <div class="col-md-8" align="center">
                            <div> 
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Update Social Link</button> 
                            </div>
                          </div>
             ...
             echo form_open_multipart("Product/manage_social",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="Copy Right" id="social_link" name="social_link" required>
                          ...
                          <div class="col-md-8" align="center">
                            <div> 
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add Social Link</button> 
