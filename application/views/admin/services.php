          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
			  ...
			  
			  {
				   ...
				   echo "Edit Our Services ".$edit->service_title;}else{echo "Add Our Services";}?></h1>
            </div>
          </div>
                    ...
                    <div class="tab-content no-bd mgbt-xs-20">
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("services",array("service_id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("Product/services/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                            
                          <h3 class="mgtp-15 mgbt-xs-20"> <b class="text-info"></b> </h3>
                           <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Service Title </span> </label>
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-5  mgbt-xs-10 mgbt-lg-0">
                                  <input type="text" name="title" class="form-control" value="<?php echo $edit->service_title;?>" />
                                </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-lg-9">
                             ...
                             <textarea name="service_description"  id="" class="form-control" rows="3"><?php echo $edit->service_description;?></textarea>
                              </div>
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Change Images </span> </label>
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span> Change Image</span> 
                              <input type="file" name="service_image" id="fileupload1">
                              <input type="hidden" name="service_image1" value="<?php echo $edit->service_image;?>" />
                             <img class="img img-responsive" src="<?php echo base_url();?>assets/images/services/<?php echo $edit->service_image;?>" id="remove_image1"/>
                              </span> 
					   ...
					   echo form_open_multipart("Product/services",array("class"=>"form-horizontal"));?>
                        
                          <h3 class="mgtp-15 mgbt-xs-20">Services</h3>
                          <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Service Title </span> </label>
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span> Service Image</span> 
                              <!-- The file input field used as target for the file upload widget -->
                              <input type="file" name="service_image" id="fileuploadalt">
                              </span>                               
                            </div>                            
                          </div>
                            <div align="center"> 
