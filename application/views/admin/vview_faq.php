    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Listing All Faq Question</h1>
             </div>
          </div>
          <div class="vd_content-section clearfix">
            <div class="row">
              <?php   $res = $this->db->get_where("meta",array('type'=>'vendor-faq'))->row();
              //print_r($res);
              	...
              	?>              <div class="col-md-12">
                              <div class="panel widget">
                                ...
                                <div class="panel-body table-responsive">
                                  ...
                                  <input type="hidden" name="type" value="vendor-faq">
              									</div>
              								</div>
              							</div>
              		                   <div class="col-md-4">
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Available Faq Question</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td><?php echo $fab->question;?></td>
                          <td><?php echo $fab->answer;?></td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/vadd_faq/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a>
...
<script>
              ...
              $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/product/vdel_faq',
               data: {fid:sid},
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/vfaq_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/vfaq_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
