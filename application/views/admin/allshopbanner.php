              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Fabric Banner</h3>
                  </div>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td width="50%;"><img style="max-width: 50%;" src="<?php echo base_url();?>assets/images/shopbanner/<?php echo $ban->shopbanner;?>" /></td>
                         
                        
                       
                        <td> 
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/shopbanner/<?php echo $ban->id;?>"><i class="fa fa-edit"></i></a> 
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                      var sid=thisvari.attr('id');
                                          ...
                                          $.ajax({
                                           type: "POST",
                                           url: '<?php echo base_url();?>index.php/Product/delshopbanner',
                                           data: {sid:sid},
