...
<link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
<?php   $res = $this->db->get_where("meta",array('type'=>'brands'))->row();
//print_r($res);
	...
	?>              <div class="col-md-12">
                              ...
                              <div class="tab-content no-bd mgbt-xs-20">
                                ...
                                <?php
          					   if($this->uri->segment(3)){
          						   $edit=$this->db->get_where("brand_contant",array("id"=>$this->uri->segment(3)))->row();
          						  // print_r ($edit);
          						   //die;
          						   echo form_open_multipart("Product/addbrandcontant/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                                    ...
                                    <h3 class="mgtp-15 mgbt-xs-20">Add Brand Post</h3>
                                    <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       <label  class="control-label col-lg-3" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type">  URL </span></label>
                                       <div class="col-lg-9">
                                         <div class="vd_radio radio-success">
                                       <input type="text" class="form-control" value="<?php echo $edit->url; ?>" name="url" placeholder="Insert URL" required="" />
                                         </div>
          					   ...
          					   echo form_open_multipart("Product/addbrandcontant",array("class"=>"form-horizontal"));?>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-9">
                                         <div class="vd_radio radio-success">
                                       <input type="text" class="form-control" name="url" placeholder="Insert URL" required="" />
                                         </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-2"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span> Cover Image</span>
                                        ...
                                        <div class="col-md-3">
                                      <div>
                                      <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add Brand Post</button>
                ...
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Slider</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <!--seo-->
                    <div class="vd_content-section clearfix" id="ecommerce-product-add">
                      <div class="row">
                       ...
                       echo form_open_multipart("Product/addsliderimg",array("class"=>"form-horizontal"));?>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                         ...
                         <?php
                         $fab = $this->db->get('brand_slider')->result();
                         $i=1;foreach($fab as $fab){?>
                        <tr class="gradeA">
                          <td align="center"><?php echo $i;?></td>
                          <td><img src="<?php echo base_url(); ?>assets/images/<?php echo $fab->banner_image;?>" alt=""></td>
