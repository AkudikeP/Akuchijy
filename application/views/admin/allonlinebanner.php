    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">  
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>All Online Boutique Banner</h1>
             </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>All Online Boutique Banner</h3>
                  </div>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td width="50%;"><img style="max-width: 50%;" src="<?php echo base_url();?>assets/images/shopbanner/<?php echo $ban->accessoriesbanner;?>" /></td>
                         
                        
                       
                        <td> 
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/onlinebanner/<?php echo $ban->id;?>"><i class="fa fa-edit"></i></a> 
                          <button data-toggle="tooltip" title="Delete" class="btn btn-xs vd_btn vd_bg-red allshop" id="<?php echo $ban->id;?>" type="button"><i class="fa fa-trash-o"></i></button>
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                      var sid=thisvari.attr('id');
                                          ...
                                          $.ajax({
                                           type: "POST",
                                           url: '<?php echo base_url();?>index.php/Product/delonlinebanner',
                                           data: {sid:sid},
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/shopbanner_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/shopbanner_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
