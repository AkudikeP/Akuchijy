    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Fabric";}else{echo "Add Front Banner";}?></h1>
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
              ...
              $button_name='update';
						   $edit=$this->db->get_where("banner",array("id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("Product/manage_banner/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
  ...
  <strong>Note: </strong> Banner image maximum height is 250px
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"><span>Change Cover Image</span> <div id="image-holder1"> </div>
                              ...
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/banner/<?php echo $edit->banner_image;?>" id="remove_image1"/>
                              </span> 
                        ...
                        <div class="col-md-8" align="center">
                            ...
                            <a  href="<?php echo base_url();?>index.php/product/manage_banner" class="btn btn-default btn-sm">
               ...
               $button_name='submit';
					   ...
					   echo form_open_multipart("Product/manage_banner",array("class"=>"form-horizontal"));?>
  ...
  <strong>Note: </strong> Banner image maximum height is 250px
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span>banner_image</span> <div id="image-holder1"> </div>
                              <!-- The file input field used as target for the file upload widget -->
                              <input type="file" name="banner_image" id="fileupload1" required="">
                              </span> 
                               <div id="remo1" class="btn">Remove</div>
                            </div>                           
