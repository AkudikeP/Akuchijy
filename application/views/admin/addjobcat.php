    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Job Category";}else{echo "Job Category";}?></h1>
              ...
              <div class="col-sm-12 col-md-4 col-lg-12">
                <div class="form-wizard condensed mgbt-xs-20" style="display:none">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tabinfo" data-toggle="tab"> <i class="fa fa-info-circle append-icon"></i> Job Category </a></li>
                    ...
                    <div class="tab-content no-bd mgbt-xs-20">
                      ...
                      <?php 
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("tbl_careercategory",array("cat_id"=>$this->uri->segment(3)))->row();
						  // print_r ($edit);
						   //die;
						   echo form_open_multipart("Product/editjcat/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                            
                          <h3 class="mgtp-15 mgbt-xs-20"> <b class="text-info"></b> </h3>
                          <div class="form-group">
                            <label for="name_1" class="control-label col-lg-3 required"> 
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}"> Category Name </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" value="<?php echo $edit->cat_name; ?>" required name="cat_name" class="form-control"  >
                                </div>
					   ...
					   echo form_open_multipart("Product/addjcat",array("class"=>"form-horizontal"));?>
                        
                        
                         
                          <h3 class="mgtp-15 mgbt-xs-20" style="padding-bottom:10px;">Add Job Category</h3>                          
                         <div class="form-group">
                            <label  class="control-label col-lg-3" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Category Name </span></label>
                            <div class="col-lg-4">
                              <div class="vd_radio radio-success">
                            <input type="text" class="form-control" name="cat_name" placeholder="Enter job category name" />
                              </div>
                           ...
                           <div align="center">
                            <div> 
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add Job Category</button> 
