    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>All Stitching Notifications</h1>
             </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>All Stitching Notifications</h3>
                  </div>
              ...
              if(!empty($nor5->sstatus)){ ?>
                    <li> <a href="#">
                        <div class="menu-icon vd_blue"></div>
                            <div class="menu-text"><a href="<?php echo base_url();?>product/stit_status/<?php echo $nor5->oid; ?>">  OMD-<?php echo $nor5->oid."&nbsp&nbsp&nbsp&nbsp".$nor5->pname;?> is <?php echo $nor5->sstatus;?> by TMD-<?php echo $nor5->tid;?>.</a>
