...
<a href="<?php echo base_url(); ?>product/excel_accessories"><button class="btn btn-primary">Excel</button></a>
<a href="<?php echo base_url(); ?>product/download_pdf_accessories"><button class="btn btn-primary">Pdf</button></a>
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          <td align="center"><?php echo $i;?></td>
                           <td class="center"><?php echo $fab->padddate;?></td>
            ...
            ?>
                          ...
                          <td width="200px"><?php echo $fab->brand;?></td>
                          </td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/add_accessories/<?php echo $fab->acc_id;?>"><i class="fa fa-edit"></i></a> 
                          <button data-toggle="tooltip" title="Delete" class="btn btn-xs vd_btn vd_bg-red del_fabric" id="<?php echo $fab->acc_id;?>" type="button"><i class="fa fa-trash-o"></i></button>
                          <?php if($fab->status_enable=='enable'){
                              echo"<button data-toggle='tooltip' title='Enable' class='btn btn-xs btn-success services_disable' id='$fab->acc_id'><i class='fa fa-lightbulb-o'></i></button>";
                              }else{
                                echo "<button data-toggle='tooltip' title='Disable' class='btn btn-xs btn-danger services_enable' id='$fab->acc_id'><i class='fa fa-lightbulb-o'></i></button>";
                                } ?>
                                </td>
                        </tr>
                        <?php $i++;}?>
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/acc_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/acc_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
