    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
              ...
              $edit=$this->db->get_where("add_link_menu",array("id"=>$this->uri->segment(3)))->row();
               echo form_open_multipart("Product/add_link_menu/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                           
                          <h3 class="mgtp-15 mgbt-xs-20"> Details</h3>

                          <div class="form-group">
                            <label for="social_link" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax."> Link Menu Name</span> </label>
                            <div class="col-lg-6">
                              
                                <input type="text" placeholder="Copy Right" id="link_menu_name" name="link_menu_name" required value="<?php echo $edit->link_menu_name;?>">
