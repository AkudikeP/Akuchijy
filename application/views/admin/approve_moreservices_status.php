...
<style>
                      ...
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group"> <span class="input-group-addon">&#8358; </span>
                                <input type="number" value="<?php echo $edit->price_without_tax;?>" onChange="this.value = this.value.replace(/,/g, '.');" placeholder="500" id="wholesale_price" name="price" maxlength="4">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="">
                            ...
                            <a  href="<?php echo base_url();?>index.php/product/more_services" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            <i class="fa fa-times append-icon"></i> Add New Service</a>
                            <a  href="<?php echo base_url();?>index.php/product/moreservices_status_change/<?php echo $edit->id; ?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            <i class="fa fa-check" aria-hidden="true"></i>
                            Approve</a><input type="hidden" name="pagename" value="more_services_status_change">
                            </div>
                          </div>
                          <!-- form-group -->
                           <?php echo form_close();
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <input type="hidden" name="pname" value="<?php echo $edit->subcategory; ?>">
        <input type="hidden" name="vendorid" value="<?php echo $edit->vendor_id; ?>">
        <input type="hidden" name="redirect" value="<?php echo current_url(); ?>">
        <input type="hidden" name="type" value="more_services">
  ...
  <?php
					   ...
					   echo form_open_multipart("Product/more_services",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            <label for="code_1" class="control-label col-lg-3 required"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product reference number (SKU-10423, etc.)"> Title Name </span> </label>
                            <div class="col-lg-4">
                          ...
                          <div class="form-group">
                            <label for="weight" class="control-label col-lg-3">price</label>
                            <div class="col-lg-4">
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="vd_checkbox checkbox-success">
                                   <input type="number" min="0" name="price" class="form-control" placeholder="Min Price" />
                                  </div>
                                </div>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("more_services",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("Product/add_more_services_meta/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
               <div class="vd_panel-menu">
                            <div>
             ...
             echo form_open("Product/add_more_services_meta",array("class"=>"form-horizontal"));?>
              <div class="vd_panel-menu">
                            <div>
             ...
             if($this->uri->segment(3)){
              $edit=$this->db->get_where("more_services",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("Product/add_more_services_city/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                             <div class="vd_panel-menu">
                            <div>
             ...
             echo form_open("Product/add_more_services_city",array("class"=>"form-horizontal"));?>
            ...
            <div id="tabatta" class="tab-pane">
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("more_services",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("Product/add_more_services_offer/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                             <div class="vd_panel-menu">
                            <div>
             ...
             echo form_open("Product/add_more_services_offer",array("class"=>"form-horizontal"));?>
