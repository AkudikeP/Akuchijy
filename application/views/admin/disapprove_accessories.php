    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">  
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Accessories Added By Vendors</h1>
             </div>
          </div>
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          <td align="center"><?php echo $i;?></td>
                           <td><?php echo $fab->padddate;?></td>
                           <td><?php echo 'PAMD-'.$fab->acc_id;?></td>
                          ...
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/accessories_status/<?php echo $fab->acc_id;?>"><i class="fa fa-edit"></i></a> 
