    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">  
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Listing All Bridal Banner</h1>
             </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Bridal Banner</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                         ...
                         <?php $i=1;foreach($ban as $ban){?>
                        <tr class="gradeA">
                          <td class="center"><?php echo $i;?></td>
                          <td><img style="max-width: 25%;" src="<?php echo base_url();?>assets/images/bridal-banner/<?php echo $ban->bridal_banner;?>" /></td>
                        <td> 
                          <a class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit" href="<?php echo base_url();?>index.php/product/bridal_banner/<?php echo $ban->bridal_banner_id;?>"><i class="fa fa-edit"></i></a> 
                          <button data-toggle="tooltip" title="Delete" class="btn btn-xs vd_btn vd_bg-red del_service" id="<?php echo $ban->bridal_banner_id;?>" type="button"><i class="fa fa-trash-o"></i></button>
                          <?php if($ban->status=='enable'){
                              echo"<button data-toggle='tooltip' title='Enable' class='btn btn-xs btn-success services_disable' id='$ban->bridal_banner_id'><i class='fa fa-lightbulb-o'></i></button>";
                              }else{
                                echo "<button data-toggle='tooltip' title='Disable' class='btn btn-xs btn-danger services_enable' id='$ban->bridal_banner_id'><i class='fa fa-lightbulb-o'></i></button>";
                                } ?>
                                </td>
...
<script>	
              ...
              $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/product/del_bridal_banner',
               data: {sid:sid},
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/bridal_banner_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/bridal_banner_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
