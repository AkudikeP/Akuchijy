                 ...
                 <div class="login-icon entypo-icon"> <i class="icon-key"></i> </div>     
                    <div class="form-group  mgbt-xs-20">
                      <div class="col-md-12">
                        ...
                        <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-user"></i> </span>
                          <input type="password" placeholder="new password" id="npassword" name="npassword" class="required" required>
                        </div>
                        <div class="label-wrapper">
                          <label class="control-label sr-only" for="cpassword">Confirm Password</label>
                        </div>
                        <div class="vd_input-wrapper" id="password-input-wrapper" > <span class="menu-icon"> <i class="fa fa-lock"></i> </span>
                          <input type="password" placeholder="Password" id="cpassword" name="cpassword" class="required" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-12 text-center mgbt-xs-5">
                        <button class="btn vd_bg-green vd_white width-100" type="submit" id="newpassword_id">Submit</button>
                      </div>
                </div>
              </div>
            </div>
...
<script>
          $(document).ready(function(){//alert("sadf");
            ...
            $("#newpassword_id").click(function(e){e.preventDefault();
            ...
            $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/welcome/changenew_pass2',
               data: {cp:cp,np:np},
