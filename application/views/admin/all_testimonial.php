                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                         ...
                         <?php $i=1;foreach($testi as $testi){?>
                        <tr class="gradeA">
                          <td class="center"><?php echo $i;?></td>
                          <td width="100px;"><img style="max-width: 50%;" src="<?php echo base_url();?>assets/images/testimonialimage/<?php echo $testi->image;?>" /></td>
                          <td><?php echo $testi->name;?></td>
                          <td><?php echo $testi->content;?></td>
                        
                          </td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/addtestimonial/<?php echo $testi->t_id;?>"><i class="fa fa-edit"></i></a> 
                          <button data-toggle="tooltip" title="Delete" class="btn btn-xs vd_btn vd_bg-red del_fabric" id="<?php echo $testi->t_id;?>" type="button"><i class="fa fa-trash-o"></i></button>
                          <?php if($testi->status=='enable'){
                              echo"<button data-toggle='tooltip' title='Enable' class='btn btn-xs btn-success services_disable' id='$testi->t_id'><i class='fa fa-lightbulb-o'></i></button>";
                              }else{
                                echo "<button data-toggle='tooltip' title='Disable' class='btn btn-xs btn-danger services_enable' id='$testi->t_id'><i class='fa fa-lightbulb-o'></i></button>";
                                } ?>
                                </td>
                        </tr>
                        <?php $i++;}?>
...
<script>	
              ...
              $.ajax({
               ...
               url: '<?php echo base_url();?>index.php/product/del_testi',
               data: {sid:sid},
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/testimonial_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/testimonial_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
