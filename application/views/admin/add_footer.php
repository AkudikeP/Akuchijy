    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Footer";}else{echo "Add Footer";}?></h1>
              ...
              <div class="col-sm-3 col-md-4 col-lg-3">
                <div class="form-wizard condensed mgbt-xs-20">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tabinfo" data-toggle="tab"> <i class="fa fa-info-circle append-icon"></i> Footer </a></li>               
                  </ul>
                </div>
              </div>
                  ...
                  <?php } ?>
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("footer",array("id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("Product/manage_footer/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                             
                          <h3 class="mgtp-15 mgbt-xs-20"> <b class="text-info"></b> </h3>
                          <div class="form-group">
                            <label for="mobile" class="control-label col-lg-3 required"> 
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}"> Mobile Number </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" required placeholder="Mobile Number" name="mobile" class="updateCurrentText" id="mobile" value="<?php echo $edit->mobile;?>">
                                </div>
                                <div class="col-sm-2">
                                </div>
                              </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" required placeholder="Heading" name="heading" class="updateCurrentText" id="name_1" value="<?php echo $edit->heading;?>">
                                </div>
                                <div class="col-sm-2">
                                </div>
                              </div>
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Mail Us Address </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="mailus_add"  id="description_1" data-rel="ckeditor" rows="3" ><?php echo $edit->mailus_add;?></textarea>
                            </div>
                          </div>
                          <!-- form-group -->

                          <div class="form-group">
                            <label for="description_11" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail.">Registered Office Address </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="office_add"  id="description_11" data-rel="ckeditor" rows="3" ><?php echo $edit->office_add;?></textarea>
                            </div>
                          </div>
                          ...
                          <div class="col-md-8" align="center">
                            <div> 
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Update Footer</button> 
                            </div>
                          </div>
					   ...
					   echo form_open_multipart("Product/manage_footer",array("class"=>"form-horizontal"));?>
                        
                        
                         
                          <h3 class="mgtp-15 mgbt-xs-20"> Footer Details</h3>
                          <div class="form-group">
                            <label for="mobile" class="control-label col-lg-3 required"> 
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}"> Mobile Number </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" required placeholder="Mobile Number" name="mobile" class="updateCurrentText" id="mobile" >
                                </div>
                                <div class="col-sm-2">
                                </div>
                              </div>
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Mail Us Address </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="mailus_add"  id="description_1" data-rel="ckeditor" rows="3" ></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                          ...
                          <div class="form-group">
                            <label for="description_11" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail.">Registered Office Address </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="office_add"  id="description_11" data-rel="ckeditor" rows="3" ></textarea>
                            </div>
                          </div>
                          ...
                          <div class="col-md-8" align="center">
                            <div> 
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add Footer</button> 
