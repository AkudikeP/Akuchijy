...
<head>
    <meta charset="utf-8" />
    <title>Tailor Commerce | Admin Login</title>
          ...
          <div class="vd_content-section clearfix">
            <div class="vd_login-page">
              <div class="heading clearfix">
                <div class="logo">
                  <h2 class="mgbt-xs-5"><img src="https://14.1.22.162/tailorcommerce/assets/images/logo2.jpg" alt="logo"></h2>
                </div>
                ...
                <div class="panel-body">
                 ...
                 <div id="hide_dive">
                  ...
                  <div class="alert alert-danger ">
                    ...
                    <i class="fa fa-exclamation-circle vd_red"></i></span>
                    <strong>Oops!</strong> <?php echo $this->session->flashdata('msg');?>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-12 text-center mgbt-xs-5">
                        <button class="btn vd_white width-100" type="submit" style="background-color:#000;" id="login-submit">Login</button>
                      </div>
                <?php echo form_close();?>
                <div id="fdive"><a href="javascript:void(0);">Forgot Password ?</a></div>
                </div>
                </div>


                <div id="show_dive" style="display: none;">
                <div class="form-group  mgbt-xs-20">
                      <div class="col-md-12">
                        <div class="label-wrapper sr-only">
                        ...
                        <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-user"></i> </span>
                          <input type="email" placeholder="Email" id="femail" name="femail" class="required" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-12 text-center mgbt-xs-5">
                        <button class="btn vd_bg-green vd_white width-100" type="submit" id="nepass">Submit</button>
                      </div>
                </div>
                <div id="back_id"><a href="javascript:void(0);">Back</a></div>
                </div>
              </div>
            </div>
            <!-- vd_login-page --> 
...
<script>
  $(document).ready(function(){
    ...
    $("#nepass").click(function(e){e.preventDefault();
            ...
            $.ajax({
                 ...
                 url: "<?php echo base_url();?>index.php/Welcome/forget_password2",
