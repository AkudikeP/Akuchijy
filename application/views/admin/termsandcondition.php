		...
		<script type="text/javascript" src="<?php echo base_url();?>ckfinder/ckfinder.js"></script>
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Terms and Condition";}else{echo "Terms and Condition";}?></h1>
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
              <div class="col-sm-12 col-md-4 col-lg-12">
								<?php   $res = $this->db->get_where("meta",array('type LIKE'=>'%terms-and-condition%'))->row();
								//print_r($res);
								...
								<div class="panel widget">
									...
									<div class="form-group">
										...
										<input type="hidden" name="type" value="terms-and-condition">
									</div>
								</div>
							</div>
											 <div class="col-md-4">
                ...
                <div class="form-wizard condensed mgbt-xs-20">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tabinfo" data-toggle="tab"> <i class="fa fa-info-circle append-icon"></i> Terms & Condition </a></li>
                  </ul>
                </div>
              </div>
                ...
                <div class="panel widget panel-bd-left light-widget">
                  ...
                  <div  class="panel-body">
                    <div class="tab-content no-bd mgbt-xs-20">
                      ...
                      <?php
					   echo form_open_multipart("Product/termsupdate",array("class"=>"form-horizontal"));
						foreach($termstext as $text)
					   {
					   ...
					   ?>
                          ...
                          <h3 class="mgtp-15 mgbt-xs-20">Terms and Conditions</h3>
                         <div class="form-group">
                ...
                <div class="panel widget panel-bd-left light-widget">
                  ...
                  <div  class="panel-body">
                    <div class="tab-content no-bd mgbt-xs-20">
                      <div id="tabinfo" class="tab-pane active">
                      <?php
					   echo form_open_multipart("Product/tailor_termsupdate",array("class"=>"form-horizontal"));
						foreach($termstext as $text)
					   {
					   		$pagename = $text->page_title;
							$pagedesc = $text->page_desc;
					   ...
					   ?>
                          ...
                          <h3 class="mgtp-15 mgbt-xs-20">Tailor Terms and Conditions</h3>
                         <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                              <?php $data = $this->db->get_where('tailor_terms_condition',array('id'=>3))->row(); ?>
                            <textarea class="form-control" id="editor2" name="page_desc" rows="6"><?php echo $data->content;?></textarea>
                              </div>
                            </div>
                          </div>
                        <?php echo form_close();?>
