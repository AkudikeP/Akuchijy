    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Manage Tailor Subcategories</h1>
            </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Manage Tailor Subcategories</rh3>
                  </div>
            ...
            <div class="col-sm-9 controls">
              ...
              <select class="width-70" name="type" required="">
                ...
                <option value="3" <?php if($medit->type==3){echo "selected"; } ?>>Sleeves</option>
					...
					{
					echo form_open_multipart("product/add_subcategories/",array("class"=>"form-horizontal"));?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 controls">
              ...
              <input type="hidden" name="old" value="" />
              <select class="width-70" name="category_id" required="">
                <option >Select</option>
                      ...
                      <tbody>
                       ...
                       <?php $i=1;foreach($all as $all_front){
                         ...
                         <tr class="gradeA">
                          ...
                          <td><?php foreach ($all_cat as $value) {
                           if($all_front->category_id==$value->mid)
                           {
                            echo $value->mcat_name;
                           }
                          } ?></td>
                          <td><?php echo $all_front->sub_cat_name;?></td>
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                      var sid=thisvari.attr('id');
                                          ...
                                          $.ajax({
                                           type: "POST",
                                           url: '<?php echo base_url();?>index.php/Product/subcat_del',
                                           data: {sid:sid},
