        ...
        <style>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Online Boutique Banner";}else{echo "Add Online Boutique Banner";}?></h1>
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
             ...
             if($this->uri->segment(3)){
              $button_name='update';
               $edit=$this->db->get_where("onlinebanner",array("id"=>$this->uri->segment(3)))->row();
               echo form_open_multipart("Product/onlinebanner/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"><span>Change Cover Image</span> <div id="image-holder1"> </div>
                              ...
                              <input type="file" name="shopbanner" id="fileupload1">
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/shopbanner/<?php echo $edit->accessoriesbanner;?>" id="remove_image1"/>
                              </span> 
                        ...
                        <div class="col-md-8" align="center">
                            ...
                            <a  href="<?php echo base_url();?>index.php/product/shopbanner" class="btn btn-default btn-sm">
             ...
             echo form_open_multipart("Product/onlinebanner",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                           ...
                           <div class="col-md-7" align="center">
                            <div> 
                            &nbsp&nbsp&nbsp&nbsp<input type="submit" name="<?php echo $button_name;?>" id="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn" value="Add Banner" />                          
                            </div>
                          </div>
