		...
		<script type="text/javascript" src="<?php echo base_url();?>ckfinder/ckfinder.js"></script>	
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Careers";}else{echo "Careers";}?></h1>
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
            <?php   $res = $this->db->get_where("meta",array('type'=>'careers'))->row();
              //print_r($res);
              ...
              <div class="col-sm-12 col-md-4 col-lg-12">
                <div class="form-wizard condensed mgbt-xs-20">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tabinfo" data-toggle="tab"> <i class="fa fa-info-circle append-icon"></i> Careers </a></li>
                  </ul>
                </div>
              </div>
                ...
                <div class="panel widget panel-bd-left light-widget">
                  ...
                  <div  class="panel-body">
                    <div class="tab-content no-bd mgbt-xs-20">
                      ...
                      <?php 
					    echo form_open_multipart("Product/careersupdate",array("class"=>"form-horizontal"));
						foreach($careertext as $text)					   
					   {
					   		$cp_heading = $text->cp_heading;
							$cp_heading2 = $text->cp_heading2;
							$image = $text->cp_bannerimg;
                			$image2 = $text->other_image;
							$image3 = $text->cp_detailbanner;
							$cp_imgtitle = $text->cp_imgtitle; 
							$cp_desc1 = $text->cp_desc1;
							$cp_desc2= $text->cp_desc2;
					   ...
					   ?>                      
                          ...
                          <h3 class="mgtp-15 mgbt-xs-20">Careers</h3>      
                         <div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Heading Title 1</span></label>
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                              <input type="text" name="cp_heading"  value="<?php echo $cp_heading;?>"  class="form-control" placeholder="WE ARE HIRING ">
                              </div>
                            </div>
                          </div>				
                         <div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Heading Title 2</span></label>
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                              <input type="text" name="cp_heading2"  value="<?php echo $cp_heading2;?>"  class="form-control" placeholder="Current Opening">
                              </div>
                            </div>
                          </div>							                      
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                              <input type="file" name="cp_bannerimg" id="userimage" >
							  <img src="<?php echo base_url();?>assets/images/<?php echo $userimg;?>"  alt="User Image" width="150" />
                					<input type="hidden" name="cp_bannerimg_hidden" value="<?php echo $userimg;?>">
                              </div>
                            </div>
                          </div>
                           <div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type">Team Image </span></label>
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                              <input type="file" name="other_image" id="userimage" >
                <img src="<?php echo base_url();?>assets/images/<?php echo $userimg2;?>"  alt="User Image" width="150" />
                 <input type="hidden" name="other_image_hidden" value="<?php echo $userimg2;?>">
                              </div>
                            </div>
                          </div>
                           <div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type">Career Detail Banner </span></label>
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                              <input type="file" name="cp_detailbanner" id="userimage" >
							<img src="<?php echo base_url();?>assets/images/<?php echo $userimg3;?>"  alt="User Image" width="150" />
							 <input type="hidden" name="other_image_hidden3" value="<?php echo $userimg3;?>">
                              </div>
                            </div>
                          </div>						  
                         <div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Banner Title </span></label>
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                              <input type="text" name="cp_imgtitle"  value="<?php echo $cp_imgtitle;?>"  class="form-control">
                              </div>
                            </div>
                          </div>						  
							<div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Description 1</span></label>
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                            <textarea class="form-control" id="editor1" name="cp_desc1" ><?php echo $cp_desc1;?></textarea>
                              </div>
                            </div>
                          </div>						  
						<div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Description 2</span></label>
                            <div class="col-lg-10">
                              <div class="vd_radio radio-success">
                            <textarea class="form-control" id="editor2" name="cp_desc2" ><?php echo $cp_desc2;?></textarea>
                              </div>
                            </div>
                          </div>						  
