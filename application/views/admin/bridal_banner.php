        ...
        <style>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Fabric";}else{echo "Add Bridal Banner";}?></h1>
          ...
          <div class="vd_content-section clearfix" id="ecommerce-product-add">
            <div class="row">
             ...
             if($this->uri->segment(3)){
              $button_name='update';
               $edit=$this->db->get_where("bridal_banner",array("bridal_banner_id"=>$this->uri->segment(3)))->row();
               echo form_open_multipart("Product/bridal_banner/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
  ...
  <strong>Note: </strong> Banner image maximum height is 250px
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"><span>Change Cover Image</span> <div id="image-holder1"> </div>
                              <input type="file" name="bridal_banner" id="fileupload1">
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/bridal-banner/<?php echo $edit->bridal_banner;?>" id="remove_image1"/>
                              </span> 
                          ...
                          <div class="col-md-8" align="center">
                            ...
                            <a  href="<?php echo base_url();?>index.php/product/bridal_banner" class="btn btn-default btn-sm">
             ...
             echo form_open_multipart("Product/bridal_banner",array("class"=>"form-horizontal"));?>
