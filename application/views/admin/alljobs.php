              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All  Jobs</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                         ...
                         <?php $i=1;foreach($vacancy as $cats){?>
                        <tr class="gradeA">
                          <td class="center"><?php echo $i;?></td>     
                          <td><?php echo $cats->cat_name;?></td>                  
                          <td><?php echo $cats->job_title;?></td>
                          <td><?php echo $cats->job_type;?></td>           
						  <td><?php echo $cats->expire_date;?></td>                                                    
                          <td><?php echo $cats->name;?></td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/addjobs/<?php echo $cats->vac_id;?>"><i class="fa fa-edit"></i></a> 
                          <button data-toggle="tooltip" title="Delete" class="btn btn-xs vd_btn vd_bg-red del_fabric" id="<?php echo $cats->vac_id;?>" type="button"><i class="fa fa-trash-o"></i></button>
                                </td>
                        </tr>
                        <?php $i++;}?>
...
<script>	
              ...
              $.ajax({
               ...
               url: '<?php echo base_url();?>index.php/product/del_jobs',
               data: {sid:sid},
