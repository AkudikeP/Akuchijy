    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit";}else{echo "Add Question";}?></h1>
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
              <?php   $res = $this->db->get_where("meta",array('type'=>'payment'))->row();
              //print_r($res);
                    ...
                    <div class="tab-content no-bd mgbt-xs-20">
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("paymentfaq",array("id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("Product/payment/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="answer"  id="editor1" data-rel="ckeditor" rows="5" ><?php echo $edit->answer;?></textarea>
                            </div>
                          </div>
                          <div class="col-md-9" align="center">
                            ...
                            <a  href="<?php echo base_url();?>index.php/product/payment" class="btn vd_btn vd_bg-blue btn-sm save-btn">
					   ...
					   echo form_open_multipart("Product/payment",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Answer </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="answer"  id="editor1" data-rel="ckeditor" rows="5" ></textarea>
                            </div>
                          </div>
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Payment Faq Question</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td width="300px"><?php echo $fab->answer;?></td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/payment/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a>
...
</script><!-- Specific Page Scripts END -->
...
<link rel="stylesheet" href="<?php echo base_url();?>adminassets/css/bundled.css">
    ...
    <script>
          $(document).ready(function(){
              ...
              $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/product/pay_del',
               data: {fid:sid},
