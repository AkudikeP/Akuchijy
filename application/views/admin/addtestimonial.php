    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Testimonial";}else{echo "Add Testimonial";}?></h1>
                    ...
                    <div class="tab-content no-bd mgbt-xs-20">
                      ...
                      <?php 
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("testimonial",array("t_id"=>$this->uri->segment(3)))->row();
						  // print_r ($edit);
						   //die;
						   echo form_open_multipart("Product/addtestimonial/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                                ...
                                <textarea name="content" class="form-control" required=""><?php echo $edit->content; ?></textarea>
                          ...
                          <div class="form-group">
                            ...
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}"> name </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" value="<?php echo $edit->name; ?>" required placeholder="Tight Long Jeans" name="name" class="form-control"  >
                                </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span> Cover Image</span> 
                              ...
                              <input type="file" name="testimonial" id="fileupload1">
                              <input type="hidden" name="testimonial" value="<?php  echo $edit->image;?>" />
                              <img class="img img-responsive" src="<?php echo base_url(); ?>assets/images/testimonialimage/<?php  echo $edit->image;?>" />
                              </span> 
                      ...
                      <div class="col-md-9" align="center">
                            <div> 
                            <button type="submit" name="testimonialbt" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Update Changes</button> 
					   ...
					   echo form_open_multipart("Product/addtestimonial",array("class"=>"form-horizontal"));?>
                        
                        
                          
                          <h3 class="mgtp-15 mgbt-xs-20">Add Testimonial</h3>
                          <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Content </span> </label>
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-2"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span> Cover Image</span> 
                              ...
                              <div class="col-lg-3">
                            <div> 
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add Testimonial</button> 
