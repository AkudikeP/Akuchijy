            ...
            <div class="row">
                ...
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Job Enquiry</h3>
                  </div>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td class="center"><?php echo $fab->name."&nbsp";?></td>
                          <td class="center"><?php echo $fab->email."&nbsp";?></td>
                          <td class="center"><?php echo $fab->mobile;?></td>
                          <td class="center"><?php echo $fab->jobtitle;?></td>
                          <td class="center"><?php echo $fab->datetime;?></td>     
                          <td class="center"><a href="<?php echo base_url().'/assets/doc/job/'.$fab->resume;?>" download> resume </a></td>                          
