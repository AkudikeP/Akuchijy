...
<link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
<?php   $res = $this->db->get_where("meta",array('type'=>'how-it-works'))->row();
//print_r($res);
                              ...
                              <div class="tab-content no-bd mgbt-xs-20">
                                ...
                                <?php
          					   if($this->uri->segment(3)){
                                    ...
                                    <h3 class="mgtp-15 mgbt-xs-20">Add How It Works Post</h3>
                                    <div class="form-group">
                                      <label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Content </span> </label>
                                      <div class="col-lg-8">
                                        <div class="row mgbt-xs-0">
          					   ...
          					   echo form_open_multipart("Product/addhowitworkscontant",array("class"=>"form-horizontal"));?>
                                   ...
                                   <div class="col-md-8" align="center">
                                      <div>
                                      <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add How It Works Post</button>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td>
                            <a data-toggle="tooltip" title="" class="btn btn-xs btn-warning" href="<?php echo base_url(); ?>product/howitworks/<?php echo $fab->id; ?>" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                  ...
                  <div class="panel-body table-responsive">
                    ...
                    <div class="vd_content-section clearfix" id="ecommerce-product-add">
                      <div class="row">
                       ...
                       echo form_open_multipart("Product/update_banner_howitworks",array("class"=>"form-horizontal"));?>
...
<script>
              ...
              $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/product/howitworks_del',
               data: {fid:sid},
