                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="input-group">
                                <input type="text" placeholder="Copy Right" id="social_link" name="heading" required value="<?php echo $edit->heading;?>">
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="input-group">
                                <input type="text" placeholder="Link Address" id="social_link1" name="link" required value="<?php echo $edit->link;?>">
                              </div>
                            </div>
                          </div>
             ...
             echo form_open_multipart("Product/add_ansvel",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="Copy Right" id="social_link" name="heading" required>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="" id="social_link1" name="link" required>
