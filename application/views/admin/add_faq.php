    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit";}else{echo "Add Faq's Question";}?></h1>
                    ...
                    <div class="tab-content no-bd mgbt-xs-20">
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("faq",array("id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("Product/add_faq/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
					   ...
					   echo form_open_multipart("Product/add_faq",array("class"=>"form-horizontal"));?>
