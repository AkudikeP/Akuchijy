                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td>
                          <a data-toggle="tooltip" title="View" class="btn btn-xs btn-success" href="<?php echo base_url();?>index.php/product/order_stitch_fabric_status/<?php echo $fab->oid;?>"><i class="fa fa-eye"></i></a> 
                         </td>
                        </tr>
                        <?php $i++;}?>
