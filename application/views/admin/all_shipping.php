...
<link href="<?php echo base_url();?>adminassets/plugins/dataTables/css/dataTables.bootstrap.css" rel="stylesheet" type="text/css">  
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>List Of All Shipping Orders</h1>
             </div>
          </div>
                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <?php //print_r($orders); ?>
                         <?php $previous=0;$i=1;foreach($orders as $fab){
                          if($fab->oid!=$previous){?>
                        <tr class="gradeA">
                          ...
                          <td>
                          <a data-toggle="tooltip" title="View" class="btn btn-xs btn-success" href="<?php echo base_url();?>index.php/product/order_shipping_status/<?php echo $fab->oid;?>"><i class="fa fa-eye"></i></a> 
                         </td>
                        </tr>
                        <?php $i++;$previous=$fab->oid;}} ?>
