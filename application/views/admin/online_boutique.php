...
<style>
                ...
                <div class="panel widget panel-bd-left light-widget">
                  ...
                  <?php } ?>
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   ...
						   echo form_open_multipart("Product/add_online/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <div class="row">
                                <div class="col-lg-9 mgbt-xs-10 mgbt-lg-0">
                                  <input type="text"  value="<?php echo $edit->brand;?>" name="brand"  id="tags_1" data-rel="tags-input" required>
                                </div>
                                <div class="col-lg-2">
                                </div>
                              </div>
                           ...
                           <div class="form-group">
                            ...
                            <span title="" data-toggle="tooltip" class="label-tooltip" > URL Title* </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" value="<?php if(empty($edit->url)){echo preg_replace('/[^A-Za-z0-9 -]/u','', strtolower(strip_tags(str_replace(" ", "-",$edit->brand)))); }else{echo $edit->url;} ?>" required placeholder="Title Name" name="url" class="  updateCurrentText " id="name_1" required >
                                </div>
                          ...
                          else
                          {
                            ?>
                             ...
                             <?php $i=0; $filter=$this->db->get_where("filter",array("filter_main_category"=>3))->result();
                            foreach($filter as $filter){?>
                 ...
                 <input type="hidden" class="sizing_guide_yes_no" name="sizing_guide_yes_no" value="" />
                          ...
                          <div class="">
                            ...
                            <a  href="<?php echo base_url();?>index.php/product/clear_offer_online/<?php echo $edit->id;?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            Clear Offer</a>
                            <a  href="<?php echo base_url();?>index.php/product/add_online" class="btn vd_btn vd_bg-blue btn-sm save-btn">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <input type="hidden" name="pid" value="<?php echo $edit->id; ?>">
        ...
        <input type="hidden" name="type" value="online_boutique">
  ...
  <?php
					   ...
					   echo form_open_multipart("Product/add_online",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"><span>Change Cover Image</span><div id="image-holder1"> </div>
                            <input type="hidden" class="fabricc_yes_no" name="fabricc_yes_no" value="" />
                              <input type="file" name="fabricc" id="fileUpload1" required="">
                              </span>
                      ...
                      <!-- #tabinfo -->
                       <div id="tabinfo1" class="tab-pane">
                        <div class="vd_panel-menu">
                          <div>  <a href="<?php echo base_url('excel/online_boutique.csv');?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">Download Excel Sheet</a> </div>
                        </div>
                        <div class="col-md-12">
                        <form action="<?php echo base_url(); ?>index.php/Excel/import_online_data"
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("online_boutique",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("Product/add_online_meta/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
               <div class="vd_panel-menu">
                            <div>
             ...
             echo form_open_multipart("Product/add_online_meta",array("class"=>"form-horizontal"));?>
              <div class="vd_panel-menu">
                            <div>
            ...
            <?php
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("online_boutique",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("Product/add_online_city/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                             <div class="vd_panel-menu">
                            <div>
             ...
             echo form_open_multipart("Product/add_online_city",array("class"=>"form-horizontal"));?>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("online_boutique",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("Product/add_online_offer/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                             <div class="vd_panel-menu">
                            <div>
             ...
             echo form_open("Product/add_online_offer",array("class"=>"form-horizontal"));?>
