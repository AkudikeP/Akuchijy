                      ...
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <div class="row">
                                <div class="col-lg-9 mgbt-xs-10 mgbt-lg-0">
                                  <input type="text" required="" value="<?php echo $edit->brand;?>" name="brand"  id="tags_1" data-rel="tags-input">
                                </div>
                                <div class="col-lg-2">
                                </div>
                              </div>
 						...
 						<div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea   name="sdesc" required="" class="form-control" ><?php echo $edit->sdesc;?></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="ldesc"  id="editor1" required="" class="form-control"><?php echo $edit->ldesc;?></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
					   ...
					   echo form_open_multipart("Product/add_accessories",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>3,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="accessories_search[]" id="<?php echo $f->filter_name.$i;?>" value="<?php echo $f->fcid;?>">
                                    <label for="<?php echo $f->filter_name.$i;?>"><?php echo $f->filter_name;?> </label>
                                    <?php $i++; }?>
                                  </div>
                                </div>
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group"> <span class="input-group-addon">&#8358; </span>
                                <input type="number"  min="0"  onChange="this.value = this.value.replace(/,/g, '.');" placeholder="500" id="wholesale_price" required="" name="wholesale_price">
                              </div>
                            </div>
                          </div>
                          <!-- form-group -->
                          ...
                          <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Short description* </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="sdesc"  class="form-control" required=""></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Description* </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="ldesc"  id="editor1" required="" class="form-control"></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
