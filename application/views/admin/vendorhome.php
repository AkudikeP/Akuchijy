...
<link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload.css" rel="stylesheet" type="text/css">
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          ...
          <div class="vd_content-section clearfix">
            <div class="row">
<?php   $res = $this->db->get_where("meta",array('type'=>'vendor-home'))->row();
//print_r($res);
	...
	?>              <div class="col-md-12">
                <div class="panel widget">
                  ...
                  <div class="panel-body table-responsive">
                    ...
                    <input type="hidden" name="type" value="vendor-home">
									</div>
								</div>
							</div>
		                   <div class="col-md-4">
                  ...
                  <div class="panel-body table-responsive">
                              ...
                              <div class="tab-content no-bd mgbt-xs-20">
                                ...
                                <?php
          					   if($this->uri->segment(3)){
          						   $edit=$this->db->get_where("vendorhome",array("id"=>$this->uri->segment(3)))->row();
          						  // print_r ($edit);
          						   //die;
          						   echo form_open_multipart("Product/addvendorcontant/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                                    ...
                                    <h3 class="mgtp-15 mgbt-xs-20">Update Post</h3>
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                        <div class="row mgbt-xs-0">
                                          <div class="col-lg-12  mgbt-xs-10 mgbt-lg-0">
                                            <textarea name="content" id="editor1" class="form-control" required=""><?php echo $edit->contant; ?></textarea>
                                          </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Small Add Images </span> </label>
                                        <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span>Small Image</span>
                                          <input type="file" name="image2" id="fileupload1">
                                          <input type="hidden" name="image2" value="<?php  echo $edit->small_image;?>" />
                                          <img class="img img-responsive" src="<?php echo base_url(); ?>assets/images/<?php  echo $edit->small_image;?>" />
                                          </span>
                                          </span>
          					   ...
          					   echo form_open_multipart("Product/addvendorcontant",array("class"=>"form-horizontal"));?>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                        <div class="row mgbt-xs-0">
                                          <div class="col-lg-12  mgbt-xs-10 mgbt-lg-0">
                                            <textarea name="content" id="editor1" class="form-control" required=""></textarea>
                                          </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Small Add Images </span> </label>
                                      <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span> Small Cover Image</span>
                                        <!-- The file input field used as target for the file upload widget -->
                                        <input type="file" name="image2" id="fileuploadalt" required="">
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                         ...
                         $fab = $this->db->get_where('vendorhome')->result();
                         $i=1;foreach($fab as $fab){?>
                        <tr class="gradeA">
                          <td align="center"><?php echo $i;?></td>
                          <td><?php echo $fab->heading;?></td>
                          <td><img src="<?php echo base_url(); ?>assets/images/<?php echo $fab->image;?>" width="30%" alt=""></td>
                          <td><img src="<?php echo base_url(); ?>assets/images/<?php echo $fab->small_image;?>" width="30%" alt=""></td>
                          <td><?php echo $fab->contant;?></td>


                          <td>
                            <a data-toggle="tooltip" title="" class="btn btn-xs btn-warning" href="<?php echo base_url(); ?>product/vendorhome/<?php echo $fab->id; ?>" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                  ...
                  <div class="panel-body table-responsive">
                    ...
                    <div class="vd_content-section clearfix" id="ecommerce-product-add">
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-12 tab-right">
                         ...
                         echo form_open_multipart("Product/vendoraddsliderimg",array("class"=>"form-horizontal"));?>


                                      
                                      <h3 class="mgtp-15 mgbt-xs-20">Add Slider Images</h3>


                                      <div class="form-group">
                                        <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Add Images </span> </label>
                                        <div class="col-lg-2"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span>Add Images</span>
                                          <!-- The file input field used as target for the file upload widget -->
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                         ...
                         <?php
                         $fab = $this->db->get('vendor_home_slider')->result();
                         $i=1;foreach($fab as $fab){?>
                        <tr class="gradeA">
                          <td align="center"><?php echo $i;?></td>
                          <td><img src="<?php echo base_url(); ?>assets/images/<?php echo $fab->banner_image;?>" alt="" width="20%"></td>

                          <td>
                          <button data-toggle="tooltip" title="" class="btn btn-xs vd_btn vd_bg-red del_img" id="<?php echo $fab->id; ?>" type="button" data-original-title="Delete"><i class="fa fa-trash-o"></i></button>
                          </td>
                        </tr>
                        <?php $i++;}?>
                ...
                <!--second-->
								<div class="panel widget">
									<div class="panel-heading vd_bg-grey">
										<h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Terms & Conditions</h3>
									</div>
									<div class="panel-body table-responsive">
										<!--seo-->
										<div class="vd_content-section clearfix" id="ecommerce-product-add">
											<div class="row">
											 ...
											 echo form_open_multipart("Product/vendorhome_pagecontant",array("class"=>"form-horizontal"));?>
																		...
																		<div class="form-group">
																		 ...
																		 // echo $contant->page_desc; ?>
																									<div class="col-lg-12">
																										<div class="vd_radio radio-success">
																									<textarea class="form-control" id="editor2" name="page_desc" ><?php echo  $contant->page_desc;?></textarea>
																										</div>
																									</div>
																								</div>
                                                <div class="col-md-12">
									...
									<div class="panel-body table-responsive">
										...
										<div class="vd_content-section clearfix" id="ecommerce-product-add">
											<div class="row">
											 ...
											 echo form_open_multipart("Product/addvendorpostcontant",array("class"=>"form-horizontal"));?>


																		
                                    <?php  $fcats=$this->db->get_where("vendorposttop",array('id'=>4))->row();
                                //echo $fcats->contant;
                                    ?>
																		<h3 class="mgtp-15 mgbt-xs-20">Add Post</h3>
																		<!--div class="form-group">
																			...
																			<div class="col-lg-8">
																				<div class="row mgbt-xs-0">
																					<div class="col-lg-12  mgbt-xs-10 mgbt-lg-0">
																						<textarea name="content" rows="8" cols="80"class="form-control" required=""><?php echo $fcats->contant ?></textarea>
                                    ...
                                    <div class="form-group">
																			<label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Heading 1 </span> </label>
																			<div class="col-lg-8">
																				<div class="row mgbt-xs-0">
																					<div class="col-lg-12  mgbt-xs-10 mgbt-lg-0">
																						<input type="text" class="form-control" name="heading1" value="<?php echo $fcats->heading1 ?>" placeholder="Insert Heading" required="" />
                                    ...
                                    <div class="form-group">
																			<label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Heading 2 </span> </label>
																			<div class="col-lg-8">
																				<div class="row mgbt-xs-0">
																					<div class="col-lg-12  mgbt-xs-10 mgbt-lg-0">
																						<input type="text" class="form-control" name="heading2" value="<?php echo $fcats->heading2 ?>" placeholder="Insert Heading" required="" />
                                    ...
                                    <div class="form-group">
                                      <label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Menu Heading 1 </span> </label>
                                      <div class="col-lg-8">
                                        <div class="row mgbt-xs-0">
                                          <div class="col-lg-12  mgbt-xs-10 mgbt-lg-0">
                                            <input type="text" class="form-control" name="menu_heading1" value="<?php echo $fcats->menu_heading1 ?>" placeholder="Insert Heading" required="" />
                                    ...
                                    <div class="form-group">
                                      <label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Menu Heading 2 </span> </label>
                                      <div class="col-lg-8">
                                        <div class="row mgbt-xs-0">
                                          <div class="col-lg-12  mgbt-xs-10 mgbt-lg-0">
                                            <input type="text" class="form-control" name="menu_heading2" value="<?php echo $fcats->menu_heading2 ?>" placeholder="Insert Heading" required="" />
 ...
 <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Facts</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <!--seo-->
                    <div class="vd_content-section clearfix" id="ecommerce-product-add">
                            ...
                            <div  class="panel-body">
                              <div class="tab-content no-bd mgbt-xs-20">
                                <div id="tabinfo" class="tab-pane active">
                                  ...
                                  $data = $this->db->get_where('vendor_home_facts',array('id'=>$this->uri->segment(5)))->row();
                         echo form_open_multipart("Product/vendoraddfact/".$this->uri->segment(5),array("class"=>"form-horizontal"));?>


                                     
                                      <h3 class="mgtp-15 mgbt-xs-20">Fact</h3>
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max.">  Line1 </span> </label>
                                       
                                          <!-- The file input field used as target for the file upload widget -->
                                         <div class="col-lg-9"> <input type="text" name="line1" id="fileuploadalt" value="<?php echo $data->line2; ?>" required="">
                                          </div>


                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-lg-3 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max.">  Line2 </span> </label>
                                       
                                          <!-- The file input field used as target for the file upload widget -->
                                         <div class="col-lg-9"> <input type="text" name="line2" value="<?php echo $data->line1; ?>" id="fileuploadalt" required="">
                                         </div> 
...
<th>Line 2</th>
                      ...
                      <tbody>
                         ...
                         <?php
                         $fab = $this->db->get('vendor_home_facts')->result();
                         $i=1;foreach($fab as $fab){?>
                        <tr class="gradeA">
                          <td align="center"><?php echo $i;?></td>
                          <td><img src="<?php echo base_url(); ?>assets/images/<?php echo $fab->banner_image;?>" alt="" width="20%"></td>
                          <td><?php echo $fab->line2; ?></td>
                          <td><?php echo $fab->line1; ?></td>

                          <td>
                         <a data-toggle="tooltip" title="" class="btn btn-xs btn-warning" href="<?php echo base_url(); ?>product/vendorhome/fact/data/<?php echo $fab->id; ?>" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                          <button data-toggle="tooltip" title="" class="btn btn-xs vd_btn vd_bg-red del_img" id="<?php echo $fab->id; ?>" type="button" data-original-title="Delete"><i class="fa fa-trash-o"></i></button>
                          </td>
                        </tr>
                        <?php $i++;}?>
...
<script>
              ...
              $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/product/vendor_contant',
               data: {fid:sid},
