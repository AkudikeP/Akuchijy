                  ...
                  <?php } ?>
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   ...
						   echo form_open_multipart("Product/add_uniform/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
...
<?php } ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                             ...
                             <input type="radio"   required="" value="yes"  name="type_feature" <?php if($edit->featured=="yes"){echo "checked";}?>  id="feature">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="radio"  required=""  value="yes" name="type_special" id="special" <?php if($edit->special=="yes"){echo "checked";}?>>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>2,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>2,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="uniform_search[]" id="<?php echo $f->filter_name;?>" value="<?php echo $f->fcid;?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group">
                                <input type="number" min="1" value="<?php echo $edit->quantity;?>" placeholder="10" id="quantity" name="quantity" required>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan <?php if($edit->Subtract_Stock=='Yes'){echo 'not';} ?>">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="number" id="minquantity" min="0"  name="minimum" value="<?php echo $edit->Minimum_Quantity; ?>" >
													 </div>
                          ...
                          <!-- form-group -->
                           ...
                           <div class="">
                            ...
                            <?php if($edit->vendor_id!=''){?>
                                                         <a  href="<?php echo base_url();?>index.php/product/clear_offer_uni/<?php echo $edit->uniform_id;?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            Clear Offer</a>
														<?php } ?>
                            <a  href="<?php echo base_url();?>index.php/product/add_uniform" class="btn vd_btn vd_bg-blue btn-sm save-btn">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <input type="hidden" name="pid" value="<?php echo $edit->uniform_id; ?>">
        <input type="hidden" name="pname" value="<?php echo $edit->school_name; ?>">
        <input type="hidden" name="vendorid" value="<?php echo $edit->vendor_id; ?>">
        <input type="hidden" name="redirect" value="<?php echo current_url(); ?>">
        <input type="hidden" name="type" value="uniform">
        <input type="hidden" name="id" value="uniform_id">
...
<?php
					   ...
					   echo form_open_multipart("Product/add_uniform",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="radio" required="" value="yes" name="type_feature" id="feature">
                                <label for="feature">Yes</label>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="radio" required="" value="yes" name="type_special" id="special">
                                <label for="special">Yes</label>
                          ...
                          <!-- form-group -->
                          <?php $i=0; $filter=$this->db->get_where("filter",array("filter_main_category"=>2))->result();
                            foreach($filter as $filter){?>
                         ...
                         <?php } ?>
                          <!-- form-group -->
                           ...
                           <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Tax* </span> </label>
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-5  mgbt-xs-10 mgbt-lg-0">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i> </span>
                                <input type="number" min="10" onChange="this.value = this.value.replace(/,/g, '.');" placeholder="500" id="wholesale_price" name="price" required="">
                              </div>
                            </div>
                          </div>
                          <!-- form-group -->
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Description* </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="ldesc"  id="description_1" data-rel="ckeditor" rows="3" required="" ></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
													...
													<div class="form-group">
														...
														<div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"><span>Change Cover Image</span><div id="image-holder1"> </div>
														<input type="hidden" class="fabricc_yes_no" name="fabricc_yes_no" value="" />
															<input type="file" name="fabricc" id="fileUpload1" req
                              >
															</span>
		 ...
		 <div id="remo5" class="btn">Remove</div>
                      ...
                      <!-- #tabinfo -->
                       <div id="tabinfo1" class="tab-pane">
                        ...
                        <div class="col-md-12">
                        <form action="<?php echo base_url(); ?>index.php/Excel/import_uniform_data"
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("uniform",array("uniform_id"=>$this->uri->segment(3)))->row();
               echo form_open("Product/add_uniform_meta/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
               <div class="vd_panel-menu">
                            <div>
             ...
             echo form_open_multipart("Product/add_uniform_meta",array("class"=>"form-horizontal"));?>
              <div class="vd_panel-menu">
                            <div>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("uniform",array("uniform_id"=>$this->uri->segment(3)))->row();
               echo form_open("Product/add_uniform_city/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                             <div class="vd_panel-menu">
                            <div>
             ...
             echo form_open_multipart("Product/add_uniform_city",array("class"=>"form-horizontal"));?>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("uniform",array("uniform_id"=>$this->uri->segment(3)))->row();
               echo form_open("Product/add_uniform_offer/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
							 <div class="vd_panel-menu">
							 <div>
             ...
             echo form_open("Product/add_uniform_offer",array("class"=>"form-horizontal"));?>
