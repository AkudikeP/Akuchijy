              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Available Social Link</h3>
                  </div>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td><?php echo $fab->category;?></td>
                          <td><?php echo $fab->social_link;?></td>
                          <td>
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/manage_social/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a> 
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-danger");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/social_disable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
                                ...
                                'confirm': {
                                    ...
                                    action: function () {
                                       ...
                                       thisvari.addClass("btn-success");
                                        $.ajax({
               type: "POST",
               url: '<?php echo base_url();?>index.php/Product/social_enable',
               data: {sid:sid},
               success: function(response){
                 //alert(response);
               }
