              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Manage Blouse Designs</h3>
                  </div>
                ...
                <option value="3" <?php if($medit->type==3){echo "selected"; } ?>>Sleeves</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-7 controls">
                          ...
                          <input type="hidden" name="kurti_or_blouse" value="1">
                    ...
                    <input id="fileupload" type="file" name="cfile" multiple>
                     <input type="hidden" name="redirect" value="add_blouse">
              ...
              <select class="width-70" name="type" required="">
                ...
                <option value="3">Sleeves</option>
                    ...
                    <input id="fileupload" type="file" name="cfile" multiple>
                    	...
                    	<div class="col-sm-4 controls">
                       <button type="submit" name="submit" class="btn btn-primary">Add Design</button>
                    </span></div>
                    </div>
                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
												<center><h3>Front Neck</h3></center>
                       <?php $i=1;foreach($all as $all_front){
                         ...
                         <tr class="gradeA">
                          ...
                          <td class="center">
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/add_blouse/<?php echo $all_front->id;?>"><i class="fa fa-edit"></i></a>
