                      ...
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
                            ...
                            <div class="col-lg-9">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>4,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="more_services_search[]" id="<?php echo $f->filter_name;?>" value="<?php echo $f->fcid;?>" <?php if (strpos($filter_check->filter_subcategory_fcid, $f->fcid)!==false) { echo 'checked';}?>>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>4,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="more_services_search[]" id="<?php echo $f->filter_name;?>" value="<?php echo $f->fcid;?>">
                                    <label for="<?php echo $f->filter_name;?>"><?php echo $f->filter_name;?> </label>
                                    <?php }?>
                                  </div>
                                </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <i class="glyphicon glyphicon-plus"></i> <span>Change Cover Image</span> 
                              ...
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/more_services/<?php echo $edit->image;?>" />
                              </span> 
					   ...
					   echo form_open_multipart("Product/more_services",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-4">
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="vd_checkbox checkbox-success">
                                   <input type="text" name="price" class="form-control" placeholder="Min Price" />
                                  </div>
                                </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-2">
                              <div class="input-group"> 
                                <input type="text" value="" placeholder="10" id="quantity" name="quantity" maxlength="4" required>
                              </div>
                            </div>
                          </div>
