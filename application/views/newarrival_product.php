...
<div id="pageContent" class="page-content page-content--fill">
				...
				<section class="content">
					...
					<div class="container">
                               ...
                               <h2 style="text-align: center; margin-bottom: 20px; margin-top: 20px;">New Arrivals</h2>
                        ...
                        <div id="filterproducts">
								 ...
								 $url =  base_url().'fabric/'.$catname->mcat_name.'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$fab['title']))).'/'.$fab['id'];
                                	...
                                	<div class="product-preview-wrapper col-md-4 col-sm-4 col-xs-6" style="max-height: 430px;">
                         				...
                         				<div class="sizes-example sizes-example1" >
																		<a href="<?php echo $url;?>">
	                                            	<img src="<?php echo base_url();?>assets/images/fabrics/resized_fabric/resize400_600/<?php echo $fab['thumb'];?>"  alt="" style="max-height: 330px; width: 220px; left:0px;"/></a>
                                        </div>
                                 ...
                                 <div class="product-preview-wrapper col-md-4 col-sm-4 col-xs-6" style="max-height: 430px;">
                         				...
                         				<div class="sizes-example sizes-example1" >
                                            <a href="<?php echo $url;?>">
                                            	<img src="<?php echo base_url();?>assets/images/accessories/resized_accessories/resize400_600/<?php echo $acc['thumb'];?>"  alt=""  style="max-height: 330px; width: 220px; left:0px;"/></a>
                                        </div>
                                 ...
                                 <div class="product-preview-wrapper col-md-4 col-sm-4 col-xs-6" style="max-height: 430px;">
                         				...
                         				<div class="sizes-example sizes-example1" >
                                            <a href="<?php echo $url;?>">
                                            	<img src="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $on['thumb'];?>"  alt=""  style="max-height: 330px; width: 220px; left:0px;"/></a>
                                        </div>
						 ...
						 <!--div id="accessory">
	<div id="loading" style="background-color: #fff;width: 100%;"><img src="<?php echo base_url(); ?>assets/images/01-progress.gif" style="position:relative; top:148px; left:12%;"></div>
  ...
  <script>
	...
	function loadmore()
	{
		...
		$.ajax({
		type: 'post',
		url: '<?php echo base_url(); ?>/welcome/get_newarrival_product',
		data: {
		 getresult:row_num
		},
