          ...
          <div class="vd_content-section clearfix" >
            <div class="vd_login-page">
              <div class="heading clearfix">
                <div class="logo">
                  <h2 class="mgbt-xs-5"><img src="<?php echo base_url();?>assets/images/logo2.png" alt="logo"></h2>
                </div>
              ...
              <div class="panel widget">
                <div class="panel-body">
                 <div class="login-icon entypo-icon"> <i class="icon-key"></i> </div>
                  <?php echo form_open("Tailor/login",array("class"=>"form-horizontal"));
                    ...
                    <div class="form-group  mgbt-xs-20">
                      <div class="col-md-12">
                        ...
                        <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-user"></i> </span>
                          <input type="text" placeholder="Email" id="Username" name="temail" class="required" required>
                        </div>
                        <div class="label-wrapper">
                          <label class="control-label sr-only" for="password">Password</label>
                        </div>
                        <div class="vd_input-wrapper" id="password-input-wrapper" > <span class="menu-icon"> <i class="fa fa-lock"></i> </span>
                          <input type="password" placeholder="Password" id="password" name="tpass" class="required" required>
                        </div>
                      </div>
                    </div>
