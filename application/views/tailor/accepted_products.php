    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">  
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Listing All Product Accepted</h1>
            </div>
          </div>
                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                         ...
                         <?php $i=1;foreach($accepted as $accepted){
                          $order = $this->db->get_where("order_items",array("id"=>$accepted->stid))->row_array();
                          ?>
                        <tr class="gradeA">
                          ...
                          <td><?php echo $accepted->adate;?></td>                          
                          <td><?php echo $order['deleivery_date'];?></td>
                          <td><?php echo $accepted->scost;?></td>
                        </tr>
                        <?php $i++;}?>
