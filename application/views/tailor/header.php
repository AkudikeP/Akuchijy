  ...
  <header class="header-1" id="header">
      <div class="vd_top-menu-wrapper">
        <div class="container ">
          ...
          <div class="vd_panel-header">
          	<div class="logo">
            	<a href="<?php echo base_url();?>Tailor"><h2><img alt="logo" src="<?php echo base_url();?>assets/images/logo3.png"></h2></a>
            </div>
            <!-- logo -->
    ...
    <li id="top-menu-2" class="one-icon mega-li"> 
      <a href="#" class="mega-link" data-action="click-trigger">
		...
		//$this->db->where("reg_date>",$cd);
		$newu=$this->db->get("users");
				echo $newu->num_rows();?>
        </span>        
      </a>
               ...
               <ul class="list-wrapper pd-lr-10">
				  ...
				  foreach($nusers as $nuser){?>
                    <li> 
                            ...
                            <div class="menu-text"> New User <?php echo $nuser->name;?> registered.
                            	<div class="menu-info">
                                    <span class="menu-date">
									<i class="fa fa-phone"></i>
                            <?php echo $nuser->mobile;?> on
    ...
    <li id="top-menu-3"  class="one-icon mega-li"> 
      <a href="#" class="mega-link" data-action="click-trigger">
		...
		<span class="badge vd_bg-red">
        <?php echo $this->db->get_where("orders",array("read_status"=>""))->num_rows();?></span>        
      </a>
               ...
               <ul  class="list-wrapper pd-lr-10">
                   <?php $this->db->select("oid,userid,odate,name,mobile");
                    ...
                    <li> <a href="#"> 
                            ...
                            <div class="menu-text">  <?php echo $nor->name;?> has placed a new order.
                            	<div class="menu-info"><span class="menu-date"><?php echo date("d M",strtotime($nor->odate));?></span></div>
                            </div> 
                    </a> </li>    <?php }?>
    ...
    <li id="top-menu-profile" class="profile mega-li"> 
        <a href="#" class="mega-link"  data-action="click-trigger"> 
            <span  class="mega-image">
                <img src="<?php echo base_url();?>assets/images/default-user-image.png" alt="example image" />               
            </span>
            <span class="mega-name">
                <?php $tailor = $this->db->get_where("tailors",array("id"=>$this->session->userdata('tid')))->row();?>
                <?php echo $tailor->tname;?> <i class="fa fa-caret-down fa-fw"></i> 
            </span>
        </a> 
      <div class="vd_mega-menu-content  width-xs-2  left-xs left-sm" data-action="click-target">
       ...
       <li> <a href="<?php echo base_url();?>Tailor/profile"> <div class="menu-icon"><i class="  fa fa-user"></i></div> <div class="menu-text">Profile</div> </a> </li>
                   
                    <li> <a href="<?php echo base_url();?>Tailor/logout"> <div class="menu-icon"><i class=" fa fa-sign-out"></i></div>  <div class="menu-text">Sign Out</div> </a> </li>       
                </ul>
            </div> 
        </div> 
      </div>     
...
<div class="content">
  <div class="container">
    ...
    <!--<li>
     ...
     <li>
    	<a href="<?php echo base_url('Tailor');?>">
        	<span class="menu-icon"><i class="fa fa-dashboard"></i></span> 
            <span class="menu-text">Dashboard</span>  
    ...
    <li>
      ...
      <div class="child-menu"  data-action="click-target">
            <ul>  
                <li>
                    <a href="<?php echo base_url();?>Tailor/accepted_order">
                        <span class="menu-text">Accepted Order</span>  
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url();?>Tailor/completed_order">
    ...
    <div class="vd_menu vd_navbar-bottom-widget">
        <ul>
            <li>
                <a href="<?php echo base_url();?>Tailor/logout">
