    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Uniform";}else{echo "Add Uniform";}?></h1>
              ...
              <div class="col-sm-12 col-md-4 col-lg-12">
                <div class="form-wizard condensed mgbt-xs-20">
                  <ul class="nav nav-tabs nav-stacked">
                    ...
                    <li><a href="#tabattach" data-toggle="tab"> <i class="fa fa-money append-icon"></i> Special Offer </a></li>
                  ...
                  <?php } ?>
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("uniform",array("uniform_id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("Vendor/add_uniform/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                           <?php if($this->session->flashdata('disapprove')){?>
  <div class="alert alert-success">
    <?php echo $this->session->flashdata('disapprove')?>
  </div>
<?php } ?>

                          <div class="form-group">
                            <label for="name_1" class="control-label col-lg-1 required">
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}">Title Name </span> </label>
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                                  <input type="text" value="<?php echo $edit->school_name;?>" required placeholder="Title Name" name="school_name" class="  updateCurrentText " id="name_1" >
                                </div>

                              </div>
                            </div>
                          </div>
                          <?php $dis_data = $this->db->get_where('disapprove',array('p_id'=>$this->uri->segment(3),'p_name'=>$edit->school_name,'vendor_id'=>$this->session->userdata('vid')))->row(); ?>
                          <?php if(isset($dis_data) && !empty($dis_data)){ ?>
                          <div class="alert alert-danger"><b>Disapprove Reason: </b>&nbsp <?php echo $dis_data->reason; ?></div>
                          <?php } ?>

                          <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-1"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Category </span> </label>
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-lg-9">
                                  <select id="manufactures_1" name="uni_category" required="">
                                  <option value="Girls" <?php if($edit->uni_category=="Girls"){echo "selected";}?>>Girls</option>
                                  <option value="Boys" <?php if($edit->uni_category=="Boys"){echo "selected";}?>>Boys</option>
                                 </select>
                                </div>
                                <div  class="col-lg-5">
                               </div>
                          ...
                          <div class="form-group">
                            <label  class="control-label col-lg-1" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type">  Featured </span></label>
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="radio"    value="yes"  name="type_feature" <?php if($edit->featured=="yes"){echo "checked";}?>  id="feature" disabled="">
                                <label for="feature">Yes</label>
                                  <input type="radio"  value="no" name="type_feature" id="feature1" <?php if($edit->featured=="no"){echo "checked";}?> disabled="">
                          ...
                          <div class="form-group">
                            <label  class="control-label col-lg-1" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Special </span></label>
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="radio"    value="yes" name="type_special" id="special" <?php if($edit->special=="yes"){echo "checked";}?> disabled="">
                                <label for="special">Yes</label>
                                  <input type="radio"  value="no" name="type_special" id="special1" <?php if($edit->special=="no"){echo "checked";}?> disabled="">
  ...
  <strong>Note:</strong> To make your product featured and special please contact our sales team on 9644409191
                          ...
                          <!-- <div class="form-group" id="apppent_id"></div>
                           form-group -->
                         <?php
                          $filter_check=$this->db->get_where("uniform_search",array("product_id"=>$this->uri->segment(3)))->row();
                          if(!empty($filter_check))
                          {

                          $filter=$this->db->get_where("filter",array("filter_main_category"=>2))->result();
                            $i=1;
                          ...
                          <div class="form-group">
                            <label for="weight" class="control-label col-lg-2"><?php echo $filter->filter_category;?></label>
                            <div class="col-lg-9">
                              <div class="row">
                                <div class="col-sm-12">
                                <div class="vd_checkbox checkbox-success">
                                <?php $i =1; $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>2,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="uniform_search[]" id="<?php echo $f->filter_name.$i;?>" value="<?php echo $f->fcid;?>" <?php if (strpos($filter_check->filter_subcategory_fcid, $f->fcid)!==false) { echo 'checked';}?>>
                          ...
                          <?php $filter=$this->db->get_where("filter",array("filter_main_category"=>2))->result();
                            foreach($filter as $filter){?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="row">
                                ...
                                <?php $i = 1; $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>2,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="uniform_search[]" id="<?php echo $f->filter_name.$i;?>" value="<?php echo $f->fcid;?>">
                                    <label for="<?php echo $f->filter_name.$i;?>"><?php echo $f->filter_name;?> </label>
                                    <?php $i++; }?>
                                  </div>
                                </div>
                          ...
                          $filter2=$this->db->get_where("main_categories",array("category"=>2))->result();
                         //print_r($filter2);
                         if(!empty($filter2))
                          {
                          ?>
                          <div class="form-group">
                            <label for="weight" class="control-label col-lg-2">Edit Category</label>
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-lg-9">
                         ...
                         <?php } ?>
                          ...
                          <!-- form-group -->
                                                    <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> SKU </span> </label>
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-lg-9">
                              ...
                              <input type="text" id="SKU" name="sku" value="<?php echo $edit->SKU; ?>">
                                                     ...
                                                     <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Tax Class </span> </label>
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-lg-9">

                                 <input type="number" value="<?php echo $edit->Tax_Class; ?>" min="0" placeholder="in percentage"  name="tax" required="">
                                </div>
                                <div  class="col-lg-5">
                               </div>
                                <!-- col-lg-9 -->
                          ...
                          <div class="form-group">
                            <label for="wholesale_price" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Price</span> </label>
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-lg-9">
                          ...
                          <!-- form-group -->
                          <div class="form-group">
                            <label for="quantity" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Quantity</span> </label>
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-lg-9">
                          ...
                          <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Subtract Stock </span> </label>
                            <div class="col-lg-9">
                              <div class="row">
                                <div class="col-lg-5">
                              ...
                              <div class="row">
                                <div class="col-lg-9">
														 ...
														 <input type="number" id="minquantity" value="<?php echo $edit->Minimum_Quantity; ?>" min="0" name="minimum" >
													 </div>
                          </div>
                        </div>
                          ...
                          <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Short description </span> </label>
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-lg-9">
                              <textarea   name="sdesc"  rows="3" required=""><?php echo $edit->sdesc;?></textarea>
                            </div>
                          </div>
                        </div>
                          </div>
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Description </span> </label>
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-2 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Add Images </span> </label>
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Cover Image</span> <div id="image-holder1"> </div>
                              ...
                              <input type="hidden" class="oldt" name="oldt" value="<?php echo $edit->uniform_image;?>" />
                              <?php if(isset($edit->uniform_image) && !empty($edit->uniform_image) && $edit->uniform_image!=' '){ ?>
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/uniform/<?php echo $edit->uniform_image;?>" id="remove_image1"/>
                              <?php } ?>
                              </span>
                             ...
                             <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Front Image</span><div id="image-holder2"> </div>
                              ...
                              <?php if(isset($edit->front) && !empty($edit->front) && $edit->front!=' '){ ?>
                               <img class="img img-responsive" src="<?php echo base_url();?>assets/images/uniform/<?php echo $edit->front;?>" id="remove_image2"/>
                               <?php } ?>
                              </span>
                            ...
                            <div class="col-lg-3">
                              <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Back Image</span><div id="image-holder3"> </div>
                                ...
                                <?php if(isset($edit->back) && !empty($edit->back) && $edit->back!=' '){ ?>
                                 <img class="img img-responsive" src="<?php echo base_url();?>assets/images/uniform/<?php echo $edit->back;?>" id="remove_image3" />
                                 <?php } ?>
                                </span>
                            ...
                            <div class="form-group">
                            <label class="control-label col-lg-2 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Sizing Guide </span> </label>
                 ...
                 <input type="hidden" class="sizing_guide_yes_no" name="sizing_guide_yes_no" value="" />
                               <?php if(isset($edit->sizing_guide) && !empty($edit->sizing_guide) && $edit->sizing_guide!=' '){ ?>
                                 <img class="img img-responsive" src="<?php echo base_url();?>assets/images/uniform/<?php echo $edit->sizing_guide;?>" id="remove_image5" />
                               <?php } ?>
                                </span>
                           ...
                           <div class="col-md-8" align="center">
                            <div>
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Update Uniform</button>
                            <?php if($edit->vendor_id!=''){?>
                                                         <a  href="<?php echo base_url();?>index.php/Vendor/clear_offer_uni/<?php echo $edit->uniform_id;?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            Clear Offer</a>
														<?php } ?>
                            <a  href="<?php echo base_url();?>index.php/Vendor/add_uniform" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            <i class="fa fa-times append-icon"></i> Add New Uniform</a>
                            </div>
                          </div>
                           <?php echo form_close();
...
<?php
					   ...
					   echo form_open_multipart("Vendor/add_uniform",array("class"=>"form-horizontal"));?>



                          <h3 class="mgtp-15 mgbt-xs-20"> Uniform Details</h3>
                           <div class="tx-rtt">
                           <div class="form-group">
                            <label for="name_1" class="control-label col-lg-1 required">
                            <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The public name for this product. Invalid characters &lt;&gt;;=#{}">Title Name </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" required placeholder="Title Name" name="school_name" class="  updateCurrentText " id="name_1" >
                                </div>
                                <div class="col-sm-2">
                                </div>
                              </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="radio"    value="yes" name="type_feature" id="feature" disabled="">
                                <label for="feature">Yes</label>
                                  <input type="radio"  value="no" name="type_feature" id="feature1" checked="" disabled="">
                                <label for="feature1">No</label>
                              </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
                             <input type="radio"    value="yes" name="type_special" id="special" disabled="">
                                <label for="special">Yes</label>
                                  <input type="radio"  value="no" name="type_special" id="special1" checked="" disabled="">
                                <label for="special1">No</label>
                              </div>
  ...
  <strong>Note:</strong> To make your product featured and special please contact our sales team on 9644409191
                          ...
                          <!--<div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Select Filter </span> </label>
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-5  mgbt-xs-10 mgbt-lg-0">
                                  <select name="filter" id="comp">
                         ...
                         if(!empty($filter2))
                          ...
                          ?>
                          <div class="form-group">
                            <label for="weight" class="control-label col-lg-2">Add Category</label>
                            <div class="col-lg-9">
                              <div class="row">
                                <div class="col-lg-5">
                         ...
                         <?php } ?>
                          <!-- form-group -->
                            ...
                            <div class="col-lg-9">
                                 <div class="row">
                                <div class="col-lg-5">
                              <input type="text" min="0" id="SKU" name="sku">
                            </div>
                          </div>
                            </div>
                           ...
                           <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Tax </span> </label>
                            <div class="col-lg-9">
                              <div class="row ">
                                <div class="col-lg-5">
                               ...
                               <div class="col-lg-5">
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan">
													 <label for="description_short_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Minimum Quantity </span> </label>
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">

														 <input type="number" id="minquantity" min="0"  name="minimum">
													 </div>
                          ...
                          <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Short description </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="sdesc"  rows="3" ></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                    ...
                    <input type="file" name="sizing_guide" id="fileupload5">
                           ...
                           <div class="col-md-5" align="center">
                            <div>
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add Uniform</button>
                      ...
                      <!-- #tabinfo -->
                       <div id="tabinfo1" class="tab-pane">
                        ...
                        <div class="col-md-4">
                        <form action="<?php echo base_url(); ?>index.php/Excel/import_uniform"
                          method="post" name="upload_excel" enctype="multipart/form-data">
                         <div class="col-md-12">  <label for="manufactures_1" class="control-label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Upload Data By Excel </span> </label></div>
                         <div class="col-md-12" style="margin-bottom:10px;"> <input type="file" name="file" id="file" style="border:none;"></div>
                         <div class="col-md-3"><button type="submit" id="submit" name="import" class="btn vd_btn vd_bg-blue btn-sm">Upload</button></div>
                         <div class="col-md-6">
                          <div>  <a href="<?php echo base_url('excel/uniform.csv');?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">Download Excel Sheet</a> </div>
                        </div>
                          </form> </div>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("uniform",array("uniform_id"=>$this->uri->segment(3)))->row();
               echo form_open("Vendor/add_uniform_meta/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open_multipart("Vendor/add_uniform_meta",array("class"=>"form-horizontal"));?>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("uniform",array("uniform_id"=>$this->uri->segment(3)))->row();
               echo form_open("Vendor/add_uniform_city/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                           
                          <h3 class="mgtp-15 mgbt-xs-20"> Uniform Details</h3>
                         <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-1"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Country </span> </label>
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                           ...
                           <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-1"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> State </span> </label>
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-6  mgbt-xs-10 mgbt-lg-0">
                           ...
                           <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-1"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> City </span> </label>
                            <div class="col-lg-6">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-8  mgbt-xs-10 mgbt-lg-0">
             ...
             echo form_open_multipart("Vendor/add_uniform_city",array("class"=>"form-horizontal"));?>
						...
						<button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Update City</button>
                          ...
                          <h3 class="mgtp-15 mgbt-xs-20"> City Details</h3>
                          <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-1"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Country </span> </label>
                            <div class="col-lg-8">
                              <div class="row mgbt-xs-0">
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("uniform",array("uniform_id"=>$this->uri->segment(3)))->row();
               echo form_open("Vendor/add_uniform_offer/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
							
                          <h3 class="mgtp-15 mgbt-xs-20"> Offer</h3>
                          <div class="form-group">
                            <label for="from_date" class="control-label col-lg-2 required">
                          ...
                          <div class="form-group">
                            <label for="to_date" class="control-label col-lg-2 required">
                         ...
                         <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures"> Offer In </span> </label>
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                          ...
                          <div class="form-group">
                            <label for="offer" class="control-label col-lg-2 required">
             ...
             echo form_open("Vendor/add_uniform_offer",array("class"=>"form-horizontal"));?>
...
$("#comp").change(function() {
    ...
    $.ajax({
        type : "POST",
        url : "<?php echo base_url('index.php/Vendor/ajax_access_uniform');?>",
        data : {sid:sid},
