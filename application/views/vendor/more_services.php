...
<style>
    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit More Services";}else{echo "Add More Services";}?></h1>
                  ...
                  <?php } ?>
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("more_services",array("id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("vendor/more_services/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                            ...
                            <div class="col-lg-5 mgbt-xs-10 mgbt-lg-0">
                              <div class="row">
                                <div class="col-lg-9 mgbt-xs-10 mgbt-lg-0">
                                  <input type="text"  value="<?php echo $edit->subcategory;?>" name="subcategory"  id="tags_1" data-rel="tags-input">
                                </div>
                                <div class="col-lg-2">
                                </div>
                              </div>
                          ...
                          <?php
                          $filter_check=$this->db->get_where("more_services_search",array("product_id"=>$this->uri->segment(3)))->row();
                          if(!empty($filter_check))
                          {

                          $filter=$this->db->get_where("filter",array("filter_main_category"=>4))->result();
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>4,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="more_services_search[]" id="<?php echo $f->fcid;?>" value="<?php echo $f->fcid;?>" <?php if (strpos($filter_check->filter_subcategory_fcid, $f->fcid)!==false) { echo 'checked';}?>>
                          ...
                          <?php } }
                            else
                            {
                              ...
                              <?php $filter=$this->db->get_where("filter",array("filter_main_category"=>4))->result();
                            foreach($filter as $filter){?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>4,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="more_services_search[]" id="<?php echo $f->fcid;?>" value="<?php echo $f->fcid;?>">
                                    <label for="<?php echo $f->fcid;?>"><?php echo $f->filter_name;?> </label>
                                    <?php }?>
                                  </div>
                                </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              ...
                              <div class="input-group"> <span class="input-group-addon">&#8358; </span>
                                <input type="number" value="<?php echo $edit->price_without_tax;?>" onChange="this.value = this.value.replace(/,/g, '.');" placeholder="500" id="wholesale_price" name="price" maxlength="4" required="">
                              </div>
                            </div>
                          </div>
                            </div>
                          </div>
                           <?php $filter2=$this->db->get_where("main_categories",array("category"=>4))->result();
                          //print_r($filter2);
                          ?>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Cover Image</span> <div id="image-holder1"> </div>
                              <input type="file" name="more_services" id="fileupload1" >
                              <input type="hidden" name="oldt" value="<?php echo $edit->image;?>" />
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/more_services/<?php echo $edit->image;?>" id="remove_image1"/>
                              </span>
                          ...
                          <div class="col-md-7" align="center">
                            ...
                            <a  href="<?php echo base_url();?>index.php/vendor/more_services" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            <i class="fa fa-times append-icon"></i> Add New Service</a>
                            </div>
                          </div>
                          <!-- form-group -->
                           <?php echo form_close();
  ...
  <?php
					   ...
					   echo form_open_multipart("vendor/more_services",array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            <label for="code_1" class="control-label col-lg-1 required"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product reference number (SKU-10423, etc.)"> Title Name </span> </label>
                            <div class="col-lg-4">
                              <input type="text"  placeholder="Sub Category" name="subcategory" class="updateCurrentText " id="code_1" >
                            </div>
                          </div>
                          <div class="form-group">
                            <label  class="control-label col-lg-1" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type">  Featured </span></label>
                          ...
                          <div class="form-group">
                            <label for="weight" class="control-label col-lg-2">price</label>
                            <div class="col-lg-4">
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="vd_checkbox checkbox-success">
                                   <input type="number" min="0" name="price" class="form-control" placeholder="Min Price" required=""/>
                                  </div>
                                </div>
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-2 file_upload_label"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Format JPG, GIF, PNG. Filesize 8.00 MB max."> Add Images </span> </label>
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span> Cover Image</span> <div id="image-holder1"> </div>
                              <input type="file" name="more_services" id="fileupload1" required="">
                              </span>
                              <div id="remo1" class="btn">Remove</div>
                            </div>
                      ...
                      <div id="tabinfo1" class="tab-pane">
                        ...
                        <div class="col-md-6">
                        <form action="<?php echo base_url(); ?>index.php/Excel/moreservice_data"
                         ...
                         <div class="col-md-2"><button type="submit" id="submit" name="import" class="btn vd_btn vd_bg-blue btn-sm">Upload</button></div>
                          <div class="col-md-4">
                          <div>  <a href="<?php echo base_url('excel/moreservice.csv');?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">Download Excel Sheet</a> </div>
                        </div>
                          </form> </div>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("more_services",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("vendor/add_more_services_meta/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open("vendor/add_more_services_meta",array("class"=>"form-horizontal"));?>
             ...
             if($this->uri->segment(3)){
              $edit=$this->db->get_where("more_services",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("vendor/add_more_services_city/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open("vendor/add_more_services_city",array("class"=>"form-horizontal"));?>
            ...
            <div id="tabatta" class="tab-pane">
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("more_services",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("vendor/add_more_services_offer/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open("vendor/add_more_services_offer",array("class"=>"form-horizontal"));?>
