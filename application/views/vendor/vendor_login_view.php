            ...
            <div class="vd_login-page">
                    ...
                    <div class="form-group  mgbt-xs-20">
                      <div class="col-md-12">
                        ...
                        <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-user"></i> </span>
                          <input type="email" placeholder="Email" id="Username" name="email" class="required" required>
                        </div>
              ...
              <div class="form-group  mgbt-xs-20">
                      <div class="col-md-12">
                        ...
                        <div class="vd_input-wrapper" id="email-input-wrapper"> <span class="menu-icon"> <i class="fa fa-user"></i> </span>
                          <input type="email" placeholder="Email" id="femail" name="email" class="required" required>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-12 text-center mgbt-xs-5">
                        <button class="btn vd_bg-green vd_white width-100" type="submit" id="fpassword">Submit</button>
                        <div id="back_id">
...
<script>
    ...
    function(){
        ...
        $("#fpassword").click(function(e){e.preventDefault();
            ...
            $.ajax({
                 ...
                 url: '<?php echo base_url();?>Vendor/forget_password',
