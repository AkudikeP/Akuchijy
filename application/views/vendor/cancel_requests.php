    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>List Of All Cancel Request</h1>
             </div>
          </div>
              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Cancel Request</h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        $order = $this->db->get_where('orders',array('oid'=>$order_item->oid))->row(); ?>
                          <td class="center"><center><?php echo $i;?></center></td>
                          <td class="center"><center>OMD-<?php echo $order_item->oid."&nbsp"; ?></center></td>
