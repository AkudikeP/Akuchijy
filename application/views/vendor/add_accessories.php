...
<style>
                  ...
                  <?php } ?>
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   ...
						   echo form_open_multipart("vendor/add_accessories/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>

                          <h3 class="mgtp-15 mgbt-xs-20"> Accessories Details</h3>

                          <div class="form-group">
                            <label for="tags_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Each tag has to be followed by a comma. The following characters are forbidden: !&lt;;&gt;;?=+#&quot;°{}_$%"> Title Name </span> </label>
                          ...
                          <div class="form-group">
                            <label for="manufactures_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Product Manufactures">Main Category </span> </label>
                                 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <div class="row">
                                <div class="col-lg-5">
                          ...
                          <div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type">  Featured </span></label>
                            <div class="col-lg-9">
                          ...
                          <div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Special </span></label>
                            <div class="col-lg-9">
                              <div class="vd_radio radio-success">
  ...
  <strong>Note:</strong> To make your product featured and special please contact our sales team on 9644409191
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <div class="row">
                                <div class="col-sm-5">
                              <input type="text" min="0" id="SKU" name="sku" value="<?php echo $edit->SKU; ?>">
                            </div>
                          </div>
                        </div>
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan <?php if($edit->Subtract_Stock=='Yes'){echo 'not';} ?>">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="number" id="minquantity" name="minimum" min="0" value="<?php echo $edit->Minimum_Quantity; ?>">
													 </div>
 						...
 						<div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="ldesc"  id="description_1" class="form-control"><?php echo $edit->ldesc;?></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                 ...
                 <input type="hidden" class="sizing_guide_yes_no" name="sizing_guide_yes_no" value="" />
                            ...
                            <a  href="<?php echo base_url();?>index.php/vendor/clear_offer_acc/<?php echo $edit->acc_id;?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            Clear Offer</a>
                            <a  href="<?php echo base_url();?>index.php/vendor/add_accessories" class="btn vd_btn vd_bg-blue btn-sm save-btn">
  ...
  <?php
					   ...
					   echo form_open_multipart("vendor/add_accessories",array("class"=>"form-horizontal"));?>
                          <h3 class="mgtp-15 mgbt-xs-20"> Accessories Details</h3>
                          <div class="form-group">
                            <label for="tags_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Each tag has to be followed by a comma. The following characters are forbidden: !&lt;;&gt;;?=+#&quot;°{}_$%"> Title </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <div class="row">
                                <div class="col-lg-5 mgbt-xs-10 mgbt-lg-0">
  ...
  <strong>Note:</strong> To make your product featured and special please contact our sales team on 9644409191
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan ">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="number" id="minquantity" name="minimum" min="0">
													 </div>
                    ...
                    <input type="file" name="sizing_guide" id="fileupload5">
                      ...
                      <!-- #tabinfo -->
                       <div id="tabinfo1" class="tab-pane">
                        ...
                        <div class="col-md-6">
                        <form action="<?php echo base_url(); ?>index.php/Excel/import_accessories"
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("accessories",array("acc_id"=>$this->uri->segment(3)))->row();
               echo form_open("vendor/add_acc_meta/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open_multipart("vendor/add_acc_meta",array("class"=>"form-horizontal"));?>
            ...
            <?php
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("accessories",array("acc_id"=>$this->uri->segment(3)))->row();
               echo form_open("vendor/add_accessories_city/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open_multipart("vendor/add_accessories_city",array("class"=>"form-horizontal"));?>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("accessories",array("acc_id"=>$this->uri->segment(3)))->row();
               echo form_open("vendor/add_acc_offer/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open("vendor/add_acc_offer",array("class"=>"form-horizontal"));?>
...
$("#accessories_1").change(function() {
    ...
    $.ajax({
        type : "POST",
        url : "<?php echo base_url();?>index.php/vendor/ajax_add_cat_acc",
        data : {sid:sid},
...
<script>
  $(document).on('change','#sub_cat_acc',function(){
    ...
    $.ajax({
        type : "POST",
        url : "<?php echo base_url();?>index.php/vendor/ajax_add_subcat_acc",
        data : {sub_id:sub_id},
        success: function(data){
      //alert(data);
          if(data)
