                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td><?php echo $fab->bitems." item(s) of Rs ".$fab->ototal;?>/-</td>
                          <td><span class="label label-info"><?php echo $fab->pay_method;?></span></td>
                          <td>
                          <a class="btn btn-xs btn-success" href="<?php echo base_url();?>index.php/Vendor/order_stitching_status/<?php echo $fab->oid;?>"><i class="fa fa-eye"></i></a> 
                         </td>
                        </tr>
                        <?php $i++;}?>
