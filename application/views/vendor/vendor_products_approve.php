    ...
    <link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Listing All Fabrics Approve By Admin</h1>
             </div>
          </div>
...
<a href="<?php echo base_url(); ?>vendor/all_fabric_approved"><button class="btn btn-primary">Excel</button></a>
      </div>
                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                         ...
                         <?php $i=1;foreach($approve as $fab){?>
                        <tr class="gradeA">
