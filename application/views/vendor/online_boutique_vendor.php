    ...
    <!-- for specific page responsive in style css -->
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1><?php if($this->uri->segment(3)){echo "Edit Online Boutique";}else{echo "Add Online Boutique";}?></h1>
              ...
              <div class="col-sm-12 col-md-4 col-lg-12">
                <div class="form-wizard condensed mgbt-xs-20">
                  <ul class="nav nav-tabs nav-stacked">
                    <li class="active"><a href="#tabinfo" data-toggle="tab"> <i class="fa fa-info-circle append-icon"></i> Add Online Boutique </a></li>
                ...
                <div class="panel widget panel-bd-left light-widget">
                  ...
                  <?php } ?>
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   $edit=$this->db->get_where("online_boutique",array("id"=>$this->uri->segment(3)))->row();
						   echo form_open_multipart("vendor/add_online/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>

                          <h3 class="mgtp-15 mgbt-xs-20"> Online Boutique Details</h3>

                          <div class="form-group">
                            <label for="tags_1" class="control-label col-lg-1"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Each tag has to be followed by a comma. The following characters are forbidden: !&lt;;&gt;;?=+#&quot;°{}_$%"> Title Name </span> </label>
                            <div class="col-lg-5 mgbt-xs-10 mgbt-lg-0">
                              <div class="row">
                                ...
                                <div class="col-lg-2">
													...
													<?php $dis_data = $this->db->get_where('disapprove',array('p_id'=>$this->uri->segment(3),'p_name'=>$edit->brand,'vendor_id'=>$this->session->userdata('vid')))->row(); ?>
                          ...
                          <?php
                          $filter_check=$this->db->get_where("online_search",array("product_id"=>$this->uri->segment(3)))->row();
                          if(!empty($filter_check))
                          {

                          $filter=$this->db->get_where("filter",array("filter_main_category"=>5))->result();
                            foreach($filter as $filter){

                              ?>

                          <div class="form-group">
                            <label for="weight" class="control-label col-lg-1"><?php echo $filter->filter_category;?></label>
                            <div class="col-lg-11">
                              <div class="row">
                                <div class="col-sm-10">
                                <div class="vd_checkbox checkbox-success">
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>5,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="online_search[]" id="<?php echo $f->filter_name;?>" value="<?php echo $f->fcid;?>" <?php if (strpos($filter_check->filter_subcategory_fcid, $f->fcid)!==false) { echo 'checked';}?>>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>5,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="online_search[]" id="<?php echo $f->fcid;?>" value="<?php echo $f->fcid;?>">
                                    <label for="<?php echo $f->fcid;?>"><?php echo $f->filter_name;?> </label>
                                    <?php }?>
                                  </div>
                                </div>
                              </div>
                          ...
                          ?>
                           <?php $filter2=$this->db->get_where("main_categories",array("category"=>5))->result();
                          //print_r($filter2);
                          ?>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> SKU </span> </label>
                             <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                              <input type="text" min="1" id="SKU" name="sku" value="<?php echo $edit->SKU; ?>">
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-9  mgbt-xs-10 mgbt-lg-0">
                                  ...
                                  <input type="number" min="0" name="tax" value="<?php echo $edit->Tax_Class; ?>" required="">
                            ...
                            <label for="quantity" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Quantity</span> </label>
                             <div class="col-lg-5">
                              ...
                              <div class="input-group">
                                <input type="text" value="<?php echo $edit->quantity;?>" placeholder="10" id="quantity" name="quantity" required>
                              </div>
                            </div>
                          </div>
                            </div>
                                ...
                                <!-- col-lg-9 -->
													...
													<div class="form-group minquan <?php if($edit->Subtract_Stock=='Yes'){echo 'not';} ?>">
													 ...
													 <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
														 ...
														 <input type="number" min="0" id="minquantity" name="minimum" value="<?php echo $edit->Minimum_Quantity; ?>">
													 </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="ldesc"  id="editor1" data-rel="ckeditor" rows="3" required=""><?php echo $edit->ldesc;?></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Cover Image</span> <div id="image-holder1"> </div>
                              ...
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/online_boutique/<?php echo $edit->thumb;?>" id="remove_image1"/>
                              <?php } ?>
                              </span>
                             ...
                             <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Front Image</span><div id="image-holder2"> </div>
                              ...
                              <?php if(isset($edit->front) && !empty($edit->front) && $edit->front!=' '){ ?>
                               <img class="img img-responsive" src="<?php echo base_url();?>assets/images/online_boutique/<?php echo $edit->front;?>" id="remove_image2"/>
                               <?php } ?>
                              </span>
                            ...
                            <div class="col-lg-3">
                              <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Back Image</span><div id="image-holder3"> </div>
                                ...
                                <?php if(isset($edit->back) && !empty($edit->back) && $edit->back!=' '){ ?>
                                 <img class="img img-responsive" src="<?php echo base_url();?>assets/images/online_boutique/<?php echo $edit->back;?>" id="remove_image3" />
                                 <?php } ?>
                                </span>
                 ...
                 <input type="hidden" class="sizing_guide_yes_no" name="sizing_guide_yes_no" value="" />
                               <?php if(isset($edit->sizing_guide) && !empty($edit->sizing_guide) && $edit->sizing_guide!=' '){ ?>
                                 <img class="img img-responsive" src="<?php echo base_url();?>assets/images/online_boutique/<?php echo $edit->sizing_guide;?>" id="remove_image5" />
                               <?php } ?>
                                </span>
...
<br>
                          <div class="col-md-9" align="center">
                            <div>
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Update Online Boutique</button>
                            <a  href="<?php echo base_url();?>index.php/vendor/clear_offer_online/<?php echo $edit->id;?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            Clear Offer</a>
                            <a  href="<?php echo base_url();?>index.php/vendor/vendor/add_online" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            <i class="fa fa-times append-icon"></i> Add New Online Boutique</a>
                            </div>
                          </div>
                           <?php echo form_close();
                           ?>
  ...
  <?php
					   ...
					   echo form_open_multipart("vendor/add_online",array("class"=>"form-horizontal"));?>



                          <h3 class="mgtp-15 mgbt-xs-20"> Online Boutique Details</h3>
                          <div class="form-group">
                            <label for="tags_1" class="control-label col-lg-1"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Each tag has to be followed by a comma. The following characters are forbidden: !&lt;;&gt;;?=+#&quot;°{}_$%"> Title </span> </label>
                            <div class="col-lg-5 mgbt-xs-10 mgbt-lg-0">
                              <div class="row">
                                <div class="col-lg-9 mgbt-xs-10 mgbt-lg-0">
                          ...
                          <?php $i=0;$filter=$this->db->get_where("filter",array("filter_main_category"=>5))->result();
                            foreach($filter as $filter){?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-11">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>5,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="online_search[]" id="<?php echo $f->fcid.$i;?>" value="<?php echo $f->fcid;?>">
                                    <label for="<?php echo $f->fcid.$i;?>"><?php echo $f->filter_name;?> </label>
                                    <?php }?>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="form-group">
                            ...
                            <label for="description_short_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> SKU </span> </label>
                             <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                              <input type="text" min="1" id="SKU" name="sku">
                            </div>
                          </div>
                        </div>
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-9 mgbt-xs-10 mgbt-lg-0">
                                  <input type="number" name="tax" min="0" placeholder="in Parcentage" required="">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                              <div class="input-group">
                                <input type="number" min="1" placeholder="10" id="quantity" name="quantity" required>
                              </div>
                            </div>
                          </div>
                            </div>
                          ...
                          <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Short description </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea  name="sdesc"  rows="3" required=""></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Description </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="ldesc"  id="editor1" data-rel="ckeditor" rows="3" required=""></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                    ...
                    <input type="file" name="sizing_guide" id="fileupload5">
                          ...
                          <div class="col-md-6" align="center">
                            <div>
                            <button type="submit" name="submit" class="btn vd_btn vd_bg-blue btn-sm save-btn"><i class="fa fa-save append-icon"></i> Add Online Boutique</button>
                      ...
                      <!-- #tabinfo -->
                       <div id="tabinfo1" class="tab-pane">
                        ...
                        <div class="col-md-6">
                        <form action="<?php echo base_url(); ?>index.php/Excel/import_online"
                         ...
                         <div class="col-md-2"><button type="submit" id="submit" name="import" class="btn vd_btn vd_bg-blue btn-sm">Upload</button></div>
                         <div class="col-md-4">
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("online_boutique",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("vendor/add_online_meta/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open_multipart("vendor/add_online_meta",array("class"=>"form-horizontal"));?>
            ...
            <?php
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("online_boutique",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("vendor/add_online_city/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open_multipart("vendor/add_online_city",array("class"=>"form-horizontal"));?>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("online_boutique",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("vendor/add_online_offer/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open("vendor/add_online_offer",array("class"=>"form-horizontal"));?>
