...
<style>
                  ...
                  <?php } ?>
                      <div id="tabinfo" class="tab-pane active">
					   ...
					   if($this->uri->segment(3)){
						   ...
						   echo form_open_multipart("Vendor/add_fabric/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-sm-9">
                                  <input type="text" value="<?php echo $edit->title;?>" required placeholder="Title Name" name="title" class="  updateCurrentText " id="name_1" >
                                </div>

                              </div>
                            </div>
                          </div>
                          <?php $dis_data = $this->db->get_where('disapprove',array('p_id'=>$this->uri->segment(3),'p_name'=>$edit->title,'vendor_id'=>$this->session->userdata('vid')))->row(); ?>
                          ...
                          <div class="form-group">
                            <label  class="control-label col-lg-1" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type">  Product Type </span></label>
                            <div class="col-lg-9">
  ...
  <strong>Note:</strong> To make your product featured and special please contact our sales team on 9644409191
                        ...
                        $filter2=$this->db->get_where("main_categories",array("category"=>1))->result();
                         //print_r($filter2);
                         if(!empty($filter2))
                          {
                          ?>
                         ...
                         <!--maincat-->
                          ...
                          <div class="form-group">
                           ...
                           <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                              <input type="text" name="sku" id="SKU" value="<?php echo $edit->SKU; ?>">
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-9 mgbt-xs-10 mgbt-lg-0">
                                  ...
                                  <input type="number" min="0" placeholder="in percentage" name="tax" value="<?php echo $edit->Tax_Class; ?>" required="">
                          ...
                          <div class="form-group">
                            <label for="quantity" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="The wholesale price is the price you paid for the product. Do not include the tax.">Product Quantity</span> </label>
                           <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                           ...
                           <div class="form-group">
                            <label  class="control-label col-lg-2" ><span data-toggle="tooltip" class="label-tooltip" data-original-title="Product type"> Minimum Qantity to buy product </span></label>
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                              <div class="vd_radio radio-success">
                             <input type="number" required="" name="min_quan_to_buy" value="<?php echo $edit->min_quan_to_buy; ?>" >
                              </div>
                            </div>
                              </div>
                          ...
                          <div class="form-group">
                           ...
                           <div class="col-lg-5">
                              ...
                              <div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i> </span>
                                <input type="number" value="<?php echo $edit->price_without_tax;?>" onChange="this.value = this.value.replace(/,/g, '.');" placeholder="500" id="wholesale_price" name="wholesale_price" maxlength="4" required="">
                              </div>
                            </div>
                          </div>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-9  mgbt-xs-10 mgbt-lg-0">
                                  <select id="" name="subtractstock" class="Subtract_Stock" required="" id="subtract_stock">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              ...
                              <textarea name="sdesc" rows="3" contenteditable="true" required=""><?php echo $edit->sdesc;?></textarea>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Cover Image</span> <div id="image-holder1"> </div>
                              ...
                              <img class="img img-responsive" src="<?php echo base_url();?>assets/images/fabrics/<?php echo $edit->thumb;?>" id="remove_image1"/>
                              <?php } ?>
                              </span>
                             ...
                             <div class="col-lg-3"> <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Front Image</span><div id="image-holder2"> </div>
                              ...
                              <?php if(isset($edit->front) && !empty($edit->front) && $edit->front!=' '){ ?>
                               <img class="img img-responsive" src="<?php echo base_url();?>assets/images/fabrics/<?php echo $edit->front;?>" id="remove_image2"/>
                               <?php } ?>
                              </span>
                            ...
                            <div class="col-lg-3">
                              <span class="btn vd_btn vd_bg-green fileinput-button"> <span>Change Back Image</span><div id="image-holder3"> </div>
                                ...
                                <?php if(isset($edit->back) && !empty($edit->back) && $edit->back!=' '){ ?>
                                 <img class="img img-responsive" src="<?php echo base_url();?>assets/images/fabrics/<?php echo $edit->back;?>" id="remove_image3" />
                                 <?php } ?>
                                </span>
                 ...
                 <input type="hidden" class="sizing_guide_yes_no" name="sizing_guide_yes_no" value="" />
                               <?php if(isset($edit->sizing_guide) && !empty($edit->sizing_guide) && $edit->sizing_guide!=' '){ ?>
                                 <img class="img img-responsive" src="<?php echo base_url();?>assets/images/fabrics/<?php echo $edit->sizing_guide;?>" id="remove_image5" />
                               <?php } ?>
                                </span>
                            ...
                            <a  href="<?php echo base_url();?>index.php/vendor/clear_offer_fabric/<?php echo $edit->id;?>" class="btn vd_btn vd_bg-blue btn-sm save-btn">
                            Clear Offer</a>
                            <a  href="<?php echo base_url();?>index.php/vendor/add_fabric" class="btn vd_btn vd_bg-blue btn-sm save-btn">
					   ...
					   echo form_open_multipart("Vendor/add_fabric",array("class"=>"form-horizontal"));?>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <div class="row">
                                ...
                                <?php $f=$this->db->get_where("filter_subcategory",array("main_category_id"=>1,"sub_category_id"=>$filter->fid))->result();
                                  foreach($f as $f){?>
                                   <input type="checkbox"  name="fabric_search[]" id="<?php echo $f->filter_name.$i;?>" value="<?php echo $f->fcid;?>">
                          ...
                          <!-- form-group -->
                          <?php $filter2=$this->db->get_where("main_categories",array("category"=>1))->result();
                          //print_r($filter2);
                          ?>
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                              <input type="text" id="SKU" min="1" name="sku">
                            </div>
                          </div>
                        </div>
                           ...
                           <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                              <div class="vd_radio radio-success">
                             <input type="number" required="" name="min_quan_to_buy" >
                              </div>
                            </div>
                              </div>
                          ...
                          <div class="form-group">
                           ...
                           <div class="col-lg-5">
                              <div class="row">
                                <div class="col-sm-9">
                              <div class="input-group"> <span class="input-group-addon"><i class="fa fa-inr"></i> </span>
                                <input type="number" onChange="this.value = this.value.replace(/,/g, '.');" placeholder="500" id="wholesale_price" name="wholesale_price" required="">
                              </div>
                            </div>
                          </div>
                            </div>
                          ...
                          <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Short description </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="sdesc" rows="3" contenteditable="true"></textarea>
                            </div>
                          <!--  <div class="col-lg-1">
                          ...
                          <div class="form-group">
                            <label for="description_1" class="control-label col-lg-2"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the body of product detail."> Description </span> </label>
                            <div class="col-lg-8 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="ldesc" id="editor1" data-rel="ckeditor" rows="3" ></textarea>
                            </div>
                          </div>
                          <!-- form-group -->
                    ...
                    <input type="file" name="sizing_guide" id="fileupload5">
                      ...
                      <div id="tabinfo1" class="tab-pane">
                        ...
                        <div class="col-md-6">
                        <form action="<?php echo base_url(); ?>index.php/Excel/import"
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("fabric",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("Vendor/add_fabric_meta/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open("Vendor/add_fabric_meta",array("class"=>"form-horizontal"));?>
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("fabric",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("Vendor/add_fabric_city/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
             ...
             echo form_open("Vendor/add_fabric_city",array("class"=>"form-horizontal"));?>
            ...
            <div id="tabatta" class="tab-pane">
             ...
             if($this->uri->segment(3)){
               $edit=$this->db->get_where("fabric",array("id"=>$this->uri->segment(3)))->row();
               echo form_open("Vendor/add_fabric_offer/".$this->uri->segment(3),array("class"=>"form-horizontal"));?>
                            ...
                            <div class="col-lg-5">
                              <div class="row mgbt-xs-0">
                                <div class="col-lg-9  mgbt-xs-10 mgbt-lg-0">
                                  ...
                                  <option value="Percentage" <?php if($edit->offer_type=='Percentage'){echo "selected";}?>>Percentage</option>
                                    <option value="Amount" <?php if($edit->offer_type=='Amount'){echo "selected";}?>>Amount</option>
                                 </select>
                                </div>
                                <div  class="col-lg-5">
                               </div>
             ...
             echo form_open("Vendor/add_fabric_offer",array("class"=>"form-horizontal"));?>
