...
<link href="<?php echo base_url();?>adminassets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css">
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Listing All Online Boutique</h1>
             </div>
          </div>
          <div class="vd_content-section clearfix">
            <div class="row">
 <div class="col-md-12 pull-left">
<a href="<?php echo base_url(); ?>vendor/all_online_approved"><button class="btn btn-primary">Excel</button></a>
      </div>
              <div class="col-md-12">
            ...
            ?>
                          ...
                          <a data-toggle="tooltip" title="Edit" class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/Vendor/add_online/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a>
