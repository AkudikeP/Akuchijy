...
$this->db->where('uniform_id', $this->uri->segment(4));
$this->db->update('uniform', $data);*/
 $mcatname = $this->db->get_where('main_categories',array('id'=>$pro->category_for_filter))->row();
    if(!empty($mcatname)){
    $url =  str_replace("--","-",base_url().'uniform/'.$pro->uni_category.'/'.str_replace(" ", "-",$mcatname->name).'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$pro->school_name))).'/'.$pro->uniform_id);
  }else{
    $url =  str_replace("--","-",base_url().'uniform/'.$pro->uni_category.'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$pro->school_name))).'/'.$pro->uniform_id);
  }
?>
        ...
        <div class="row product-info-outer">
          <div class="col-sm-4 col-md-4 col-lg-4 hidden-xs">
            <div class="product-main-image">
              ...
              <img  class="product-zoom" src='<?php echo base_url();?>assets/images/uniform/resized_uniform/resize400_600/<?php echo $pro->uniform_image;?>' data-zoom-image="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize800_1200/<?php echo $pro->uniform_image;?>"/></div>
              <div class="product-main-image__zoom"></div>
            </div>
            <div class="product-images-carousel" align="center" style: "paddin:0px">
              <ul id="smallGallery">

                <li><a href="#" data-image="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize400_600/<?php echo $pro->uniform_image;?>" data-zoom-image="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize800_1200/<?php echo $pro->uniform_image;?>"><img src="<?php echo base_url();?>assets/images/uniform/resized_uniform/small/<?php echo $pro->uniform_image;?>" alt="" style="max-height: 100px"/></a></li>
                <?php  if($pro->front!='size.jpg' && $pro->front!='back.jpg' && $pro->front!='front.jpg' && $pro->front!='' && $pro->front!=' ') {?>
                <li><a href="#" data-image="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize400_600/<?php echo $pro->front;?>" data-zoom-image="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize800_1200/<?php echo $pro->front;?>"><img src="<?php echo base_url();?>assets/images/uniform/resized_uniform/small/<?php echo $pro->front;?>" alt="" style="max-height: 100px"/></a></li>
                <?php } ?>

                <?php  if($pro->back!='size.jpg' && $pro->back!='back.jpg' && $pro->front!='front.jpg' && $pro->back!='' && $pro->back!=' ') {?>
                <li><a href="#" data-image="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize400_600/<?php echo $pro->back;?>" data-zoom-image="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize800_1200/<?php echo $pro->back;?>"><img src="<?php echo base_url();?>assets/images/uniform/resized_uniform/small/<?php echo $pro->back;?>" alt="" style="max-height: 100px" /></a></li>
                <?php } ?>
          ...
          <li><a href="<?php echo base_url();?>Welcome/shop/<?php echo $pro->uni_category;?>" style="color: #000;">Uniform</a></li>
          <li><a href="<?php echo base_url();?>Welcome/shop/<?php echo $pro->uni_category;?>" style="color: #000;"><?php echo $pro->uni_category;?></a></li>

          <li class="active"><?php echo substr($pro->school_name, 0,60);
                          if(strlen($pro->school_name)>60){echo '...';}?></li>
          ...
          <div class="product-info col-xs-12 col-sm-8 col-md-8 col-lg-8">
            ...
            <div class="product-info__title">
              <h2><?php echo $pro->school_name." ( ".$pro->SKU." )";?></h2>
            ...
            <?php  if($count_stock_remain<=0 || $count_stock_remain<=$pro->Minimum_Quantity)
              {
            ?>
          ...
          jq(document).ready(function(){
            ...
            jq("#<?php echo $pro->uniform_id; ?>").attr("disabled","disabled");
            ...
            <ul id="singleGallery" class="visible-xs">
              <li><img src="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize400_600/<?php echo $pro->uniform_image;?>" alt="" /></li>
              <?php  if($pro->front=='size.jpg' && $pro->front=='back.jpg' && $pro->front=='front.jpg' && $pro->front!='' && $pro->front!=' ') {?>

              <li><img src="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize400_600/<?php echo $pro->front;?>" alt="" /></li>
              <?php } if($pro->back=='size.jpg' && $pro->back=='back.jpg' && $pro->front=='front.jpg' && $pro->back!='' && $pro->back!=' ') {?>

              <li><img src="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize400_600/<?php echo $pro->back;?>" alt="" /></li>
<?php } ?>
            </ul>
...
<?php
            ...
            Inclusive of all taxes
             <div class="product-info__sku "><span class="label label-success" style="font-size: 12px;background-color: #358d48"><span id="rating" class="overall_rating">4.2</span> &nbsp<span class="icon-star"></span></span><span class="reviewratingtext">&nbsp&nbsp <span class="rating_count">0</span> Ratings & <span class="review_count">0</span> Reviews</span></div>




<?php
$data = $this->db->get_where('uniform_search',array('product_id'=>$pro->uniform_id))->row();
if(!empty($data)){
...
foreach ($all_filter as $value) {
  ...
  {
  $check = $this->db->get_where('filter',array('filter_main_category'=>2,'fid'=>$data->sub_category_id))->row();
...
<?php if(isset($discount)){ ?>
              var np=(parseInt(qty)*parseInt(pr))-<?php echo $discount ?>;
                var op = parseInt(qty)*parseInt(pr);
                 jq("#price").text(np);
                 jq("#oldprice").text(op);
  <?php }else if(isset($discount_per)){

    ?>
                  var np=(parseInt(qty)*parseInt(pr)*<?php echo $discount_per ?>)/100;
                  var np = (parseInt(qty)*parseInt(pr))-np;
                  var op = parseInt(qty)*parseInt(pr);
                   jq("#price").text(np);
                 jq("#oldprice").text(op);
    ...
    ?>
    var np = (parseInt(qty)*parseInt(pr));
     jq("#price").text(np);
 ...
 input[type=radio]#s<?php echo $k; ?> + label:before{
  ...
  background-color:<?php echo $value; ?>
            ...
            <div class="outer">
              ...
              <input type="hidden" name="fabric" value="<?php echo $pro->uniform_id;?>" />
              <input type="hidden" name="vendor_id" value="<?php echo $pro->vendor_id;?>" />
<input type="hidden" name="url" value="<?php echo $url;?>" />

              <?php if($count_stock_remain>0)
                { ?>
                <input type="number" name="qty" id="qty" class="input-number input--wd input-qty pull-left" value="1" min="1" max="<?php if($pro->Subtract_Stock=='yes' || $pro->Subtract_Stock=='Yes'){echo $count_stock_remain; }else{ echo $pro->quantity; } ?>">
...
">
                ...
                <button class="btn btn--wd text-uppercase" id="caddtocart" >Add to Cart</button>&nbsp&nbsp&nbsp&nbsp<span id="filter_msg" class='alert alert-danger'>Please select one color and size</span>
              </div>

              </form>
              <?php echo form_open('Welcome/fabric_with_stitching/');
                $mcat_id = $this->uri->segment(3);
              ?>
                <input type="hidden" name="mcat_id" value="<?php echo $mcat_id;?>">
                <input type="hidden" name="fabric_id" value="<?php echo $pro->uniform_id;?>" class="checkbox-group">
            &nbsp; &nbsp;&nbsp;

              <?php echo form_close();
              $wishlist = $this->db->get_where('wishlist',array('p_id'=>$pro->uniform_id,'p_name'=>$pro->school_name, 'user_id'=>$this->session->userdata("userid")))->num_rows();

               //$url =  base_url().'Welcome/uniform_product/'.$pro->uni_category.'/'.$pro->uniform_id; ?>
    <?php //$catname = $this->db->get_where('mcategory',array('mid'=>$pro->uni_category))->row();
    

   $pname = preg_replace('/[^A-Za-z0-9 ]/u','', strip_tags($pro->school_name)); ?>
            ...
            <span id="notifyme_section"><br><br><lable class="lb pull-left" >We will let you know when in stock</lable></br>
             ...
             <p id="notify_msg"><br>We will notify you when it is in stock</p>
            ...
            <?php if($wishlist>=1 ){
                ?>
                 <li><a class="overlay_img overlay_img_fill" id="<?php echo $pro->uniform_id; ?>_<?php echo $pname; ?>"><span class=" icon icon-favorite"></span  ><span class="added">Added to Wishlist</span></a></li>
 ...
 <?php if($this->session->userdata("userid")==''){
  ...
  <div class="overlay_img" id="<?php echo $pro->uniform_id; ?>_<?php echo $pro->school_name; ?>"></div>
 ...
 <a href="<?php echo base_url() ?>Welcome/login?url=<?php echo $url; ?>"><li><span class="icon icon-favorite"></span  >Add to Wishlist</li></a>
  ...
  <?php
                  ...
                  ?>
                  <li class="overlay_img" id="<?php echo $pro->uniform_id; ?>_<?php echo $pname; ?>"><a href="#"><span class="icon icon-favorite"></span  ><span class="added">Add to Wishlist</span></a></li>
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.8&appId=1045518682243789";
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>

<br />
<div class="fb-share-button" data-href="<?php echo current_url();?>" data-layout="button" data-size="large" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo current_url();?>">Share On Facebook</a></div> --></div></li>
            </ul>
<div class="flash-message alert alert-success flashalert<?php echo $pro->uniform_id; ?>" ><center>Added To Wishlist</center></div>
...
?></div>
    ...
    <section class="content content--fill">
      ...
      <?php //$info = $this->db->get_where('uniform',array('uniform_id'=>$this->uri->segment(4)))->row() ?>
          ...
          <div role="tabpanel" class="tab-pane" id="Tab2">
             ...
             <?php $review=$this->db->get_where("review",array("p_id"=>$pro->uniform_id,"p_name"=>$pro->school_name,"status"=>1))->result();
             if($this->session->userdata("userid")!=""){
                $review_my=$this->db->get_where("review",array("p_id"=>$pro->uniform_id,"p_name"=>$pro->school_name,"userid"=>$this->session->userdata('userid')))->result();
                //print_r($review_my);
             }

            $review_count=$this->db->get_where("review",array("p_id"=>$pro->uniform_id,"p_name"=>$pro->school_name,"status"=>1))->num_rows();
            ?>
            ...
            <?php //$url =  base_url().'Welcome/product/'.$pro->uni_category.'/'.$pro->uniform_id; ?>
          ...
          <div role="tabpanel" class="tab-pane" id="Tab5">
            ...
            <?php //echo $pro->sizing_guide; ?>
              <img src="<?php echo base_url(); ?>assets/images/uniform/<?php echo $pro->sizing_guide; ?>" class="sizeimg" >
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container">
        ...
        $this->db->where("uni_category",$pro->uni_category);
        $this->db->where("uniform_id!=",$this->uri->segment(4));
        $this->db->limit(10);
        $rela=$this->db->get_where("uniform",array("status"=>'approve',"status_enable"=>'enable'))->result();
        foreach($rela as $rela){

          $mcatname = $this->db->get_where('main_categories',array('id'=>$rela->category_for_filter))->row();
       	 if(!empty($mcatname)){
       	 $url =  str_replace("--","-",base_url().'uniform/'.$rela->uni_category.'/'.str_replace(" ", "-",$mcatname->name).'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$rela->school_name))).'/'.$rela->uniform_id);
        }else{
       	 $url =  str_replace("--","-",base_url().'uniform/'.$rela->uni_category.'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$rela->school_name))).'/'.$rela->uniform_id);
        }
        ?>
...
<div class="sizes-example sizes-example1">
              <a href="<?php echo $url;?>"><img src="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize400_600/<?php echo $rela->uniform_image;?>" data-lazy="<?php echo base_url();?>assets/images/uniform/resized_uniform/resize400_600/<?php echo $rela->uniform_image;?>" alt=""/></a>
</div>
  ...
  if($value1->pid==$pro->uniform_id && $value1->pname==$pro->school_name)
  {
  //  echo "<br><br>";
  $i++;
  }
  ...
  $review_num=$this->db->get_where("review",array("userid"=>$this->session->userdata("userid"),'p_id'=>$pro->uniform_id,'p_name'=>$pro->school_name))->row();
  ?>
  ...
  <input type="hidden" name="pid" value="<?php  echo $pro->uniform_id; ?>">
            <input type="hidden" name="pname" value="<?php  echo $pro->school_name; ?>">
  ...
  k('.flash-message').hide();
                   k(".overlay_img").click(function(){
                      ...
                      /*k(".overlay_img_fill").click(function(){
                                                 ...
                                                 k(".flashalert2").slideDown(500, function(){
    setTimeout(function(){
k(".flashalert2").slideUp(500);
},2000);
});
                      });
                      ...
                      k(".overlay_img").click(function(){
                       ...
                       // alert(id[0]+"-----"+id[1]);
                        ...
                        data: {'pid':id[0],'pname':id[1],'type':'uniform'},
                         success: function(response){
                          k(".flashalert" + id).slideDown(500, function(){
    setTimeout(function(){
k(".flashalert" + id).slideUp(500);
},2000);
});
   ...
   k("#notifyme").click(function(){
       ...
       // alert(notifyme);
         k.ajax({
           ...
           data: {"value":notifyme,"pid":<?php echo $pro->uniform_id; ?>,"pname":"<?php echo $pro->school_name; ?>","type":'uniform'},
           success: function(response){
            console.log(response);
    ...
    k(".rat_text").hide();
        ...
        //alert(rating);
         k.ajax({
           ...
           data: {"value":rating[1],"pid":<?php echo $pro->uniform_id; ?>,"pname":"<?php echo $pro->school_name; ?>"},
           success: function(response){
...
$rating = $this->db->get_where('rating',array('p_id'=>$pro->uniform_id,'p_name'=>$pro->school_name));
 ...
 if(!empty($rat_data) and $rat_num>0)
      ...
      $this->db->where('uniform_id',$pro->uniform_id);
      $this->db->update('uniform',array('overall_rating'=>$rating2));
      //echo $rating;
    }
     else{
      $rating2 =0;
...
<?php
    $rating = $this->db->get_where('rating',array('p_id'=>$pro->uniform_id,'p_name'=>$pro->school_name,'users'=>$this->session->userdata("userid")));
      $rat_data =$rating->row();
 if(!empty($rat_data))
      {
