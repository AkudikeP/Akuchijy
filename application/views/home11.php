<div id="pageContent" class="page-content page-content--fill">
				...
				<section class="breadcrumbs  hidden-xs">
					<div class="container">
						<ol class="breadcrumb breadcrumb--wd pull-left">
							<li><a href="#">Home</a></li>
							<li class="active">Electric Soul Skirt</li>
						</ol>
					</div>
				</section>
				<!-- Content section -->
					...
					<div class="container">
						<div class="category-outer">
							<div class="category-slider single-slider">
								<ul>
									<li><img src="<?php echo base_url();?>assets/images/category-img-1.jpg" alt="" /></li>
									<li><img src="<?php echo base_url();?>assets/images/category-img-2.jpg" alt="" /></li>
								</ul>
							</div>
							<div class="category-outer__text">
								<h2 class="category-outer__text__title text-uppercase">Women</h2>
					...
					<div class="container">
						<div class="product-category-carousel mobile-special-arrows animated-arrows slick">
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-06.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">DRESSES</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-07.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">JACKETS</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-08.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">SHIRTS</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-09.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">COATS</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-10.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">SHORTS</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-11.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">JEANS</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-12.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">SKIRTS</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-13.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">LINGERIE</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-14.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">BEACHWEAR</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							<div class="product-category hover-squared">
								<a href="#"><img src="<?php echo base_url();?>assets/images/category-empty-small.png" data-lazy="<?php echo base_url();?>assets/images/category-img-15.jpg" alt="#"></a>
								<div class="product-category__hover caption"></div>
								<div class="product-category__info">
									<div class="product-category__info__ribbon">
										<h5 class="product-category__info__ribbon__title">SHOES</h5>
										<div class="product-category__info__ribbon__count">32 products</div>
									</div>
								</div>
							</div>
							...
							<div id="leftCol">
								<div id="filtersCol" class="filters-col">
									...
									<div class="filters-col__collapse open">
										...
										<div class="filters-col__collapse__content">											<ul class="filter-list">
												<li> <a href="#"><span class="color-icon"><img src="<?php echo base_url();?>assets/images/colors/blue.png" alt=""/></span>Blue  (9)</a> </li>
												<li> <a href="#"><span class="color-icon"><img src="<?php echo base_url();?>assets/images/colors/red.png" alt=""/></span>Red  (2)</a> </li>
												<li> <a href="#"><span class="color-icon"><img src="<?php echo base_url();?>assets/images/colors/yellow.png" alt=""/></span>Yellow  (7)</a> </li>
												<li> <a href="#"><span class="color-icon"><img src="<?php echo base_url();?>assets/images/colors/grey.png" alt=""/></span>Grey  (1)</a> </li>
											</ul>
</div>
									</div>
									<div class="filters-col__collapse open">
                ...
                <a href="product.html"><img src="<?php echo base_url();?>assets/images/fabrics/<?php echo $fab->thumb;?>" alt=""/></a>
