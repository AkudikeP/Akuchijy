                    ...
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <tr class="gradeA">
                          ...
                          <td>
                          <a class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/add_fabric/<?php echo $fab->id;?>"><i class="fa fa-edit"></i></a> 
                          <button class="btn btn-xs vd_btn vd_bg-red del_fabric" id="<?php echo $fab->id;?>" type="button"><i class="fa fa-trash-o"></i></button></td>
                        </tr>
                        <?php $i++;}?>
