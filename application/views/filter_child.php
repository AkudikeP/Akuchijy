   ...
   if(!empty($fab->url))
  {
   ...
   if(!empty($mcatname)){
    ...
    $url =  str_replace("--","-",base_url().'fabric/'.strtolower($catname->mcat_name).'/'.$title_url.'/'.$fab->id);  
               ...
               <img class='lazy' data-src="<?php echo base_url();?>assets/images/fabrics/cover.jpg" alt=""/></a>
                <?php } else { ?>
                 <img class='lazy' data-src="<?php echo base_url();?>assets/images/fabrics/<?php echo $fab->thumb;?>" alt=""/></a>
                <?php } ?>
            ...
            ?>
											<div class="product-preview__info">
												...
												<!--<ul class="options-swatch options-swatch--color">
													...
													<li><a href="#"><span class="swatch-label"><img class='lazy' data-src="<?php echo base_url();?>assets/images/colors/blue.png" width="10" height="10" alt=""/></span></a></li>
