...
$this->db->update('online_boutique', $data);
   ...
   $catname = $this->db->get_where('mcategory',array('mid'=>$pro->main_category))->row();
   $mcatname = $this->db->get_where('main_categories',array('id'=>$pro->category_for_filter))->row();
   if(!empty($mcatname)){
   $url =  str_replace("--","-",base_url().'online-boutique/'.$catname->mcat_name.'/'.str_replace(" ", "-",$mcatname->name).'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$pro->brand))).'/'.$pro->id);
   }else{
   $url =  str_replace("--","-",base_url().'online-boutique/'.$catname->mcat_name.'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$pro->brand))).'/'.$pro->id);
   }
?>
        ...
        <div class="row product-info-outer">
          <div class="col-sm-4 col-md-4 col-lg-4 hidden-xs">
            <div class="product-main-image">
              ...
              <img  class="product-zoom" src='<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $pro->thumb;?>' data-zoom-image="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize800_1200/<?php echo $pro->thumb;?>"/></div>
              <div class="product-main-image__zoom"></div>
            </div>
            <div class="product-images-carousel" align="center" style: "paddin:0px">
              <ul id="smallGallery">

                <li><a href="#" data-image="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $pro->thumb;?>" data-zoom-image="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize800_1200/<?php echo $pro->thumb;?>"><img src="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/small/<?php echo $pro->thumb;?>" alt="" style="max-height: 100px"/></a></li>
                <?php  if($pro->back!='size.jpg' && $pro->back!='back.jpg' && $pro->front!='front.jpg' && $pro->front!='' && $pro->front!=' ') {?>
                <li><a href="#" data-image="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $pro->front;?>" data-zoom-image="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize800_1200/<?php echo $pro->front;?>"><img src="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/small/<?php echo $pro->front;?>" alt="" style="max-height: 100px"/></a></li>
                <?php } ?>

                <?php  if($pro->back!='size.jpg' && $pro->back!='back.jpg' && $pro->front!='front.jpg' && $pro->back!='' && $pro->back!=' ') {?>
                <li><a href="#" data-image="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $pro->back;?>" data-zoom-image="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize800_1200/<?php echo $pro->back;?>"><img src="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/small/<?php echo $pro->back;?>" alt="" style="max-height: 100px" /></a></li>
                <?php } ?>
          ...
          <li><a href="<?php echo base_url();?>Welcome/shop/<?php echo $cat->mid;?>" style="color: #000;">online_boutique</a></li>
          <li><a href="<?php echo base_url();?>Welcome/shop/<?php echo $cat->mid;?>" style="color: #000;"><?php echo $cat->mcat_name;?></a></li>

          <li class="active"><?php echo substr($pro->brand, 0,60);
                          if(strlen($pro->brand)>60){echo '...';}?></li>
          ...
          <div class="product-info col-xs-12 col-sm-8 col-md-8 col-lg-8">
            ...
            <div class="product-info__title">
              <h2><?php echo $pro->brand." ( ".$pro->SKU." )";?></h2>
            </div>
            <?php
          ...
          jq(document).ready(function(){
            ...
            <ul id="singleGallery" class="visible-xs">
              <li><img src="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $pro->thumb;?>" alt="" /></li>
              <?php  if($pro->front=='size.jpg' && $pro->front=='back.jpg' && $pro->front=='front.jpg' && $pro->front!='' && $pro->front!=' ') {?>

              <li><img src="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $pro->front;?>" alt="" /></li>
              <?php } if($pro->back=='size.jpg' && $pro->back=='back.jpg' && $pro->front=='front.jpg' && $pro->back!='' && $pro->back!=' ') {?>

              <li><img src="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $pro->back;?>" alt="" /></li>
<?php } ?>
            </ul>
...
<?php
            ...
            <span class="product-info__sku ">&nbsp;&nbsp;<span class="label label-success" style="font-size: 12x;"><?php echo $pro->offer_price;?>% OFF</span></span>
            ...
            Inclusive of all taxes
             <div class="product-info__sku "><span class="label label-success" style="font-size: 12px;background-color: #358d48"><span class="overall_rating" id="rating">4.2</span> &nbsp<span class="icon-star"></span></span><span class="reviewratingtext">&nbsp&nbsp <span class="rating_count">0</span> Ratings & <span class="review_count">0</span> Reviews</span></div>




<?php
$data = $this->db->get_where('online_search',array('product_id'=>$pro->id))->row();
if(!empty($data)){
...
foreach ($all_filter as $value) {
  ...
  {
  $check = $this->db->get_where('filter',array('filter_main_category'=>5,'fid'=>$data->sub_category_id))->row();
...
//print_r($size_arr); ?>
        ...
        //alert(formdata);
          ...
          jq.ajax({
             ...
             url: '<?php echo base_url();?>index.php/Welcome/addtocart_boutique',
 ...
 input[type=radio]#s<?php echo $k; ?> + label:before{
  ...
  background-color:<?php echo $value; ?>
            ...
            <div class="outer">
              ...
              <input type="hidden" name="fabrics" value="<?php echo $pro->id;?>" />
              <input type="hidden" name="vendor_id" value="<?php echo $pro->vendor_id;?>" />
              <input type="hidden" name="url" value="<?php echo $url;?>" />

              <?php if($count_stock_remain>0)
                { ?>
                <input type="text" name="qty" id="qty" class="input-number input--wd input-qty pull-left" value="1" min="1" max="<?php if($pro->Subtract_Stock=='yes' || $pro->Subtract_Stock=='Yes'){echo $count_stock_remain; }else{ echo $pro->quantity; } ?>">
...
">
                ...
                <button class="btn btn--wd text-uppercase" id="caddtocart" >Add to Cart</button>&nbsp&nbsp&nbsp&nbsp<span style="position: absolute;
    margin-left: 11%;
    margin-top: -0.2%;"
    id="filter_msg" class="alert alert-danger">Please select one color and size</span>
              </div>
            ...
            &nbsp; &nbsp;&nbsp;<br><br>
              ...
              $wishlist = $this->db->get_where('wishlist',array('p_id'=>$pro->id,'p_name'=>$pro->brand, 'user_id'=>$this->session->userdata("userid")))->num_rows();
            
$pname = preg_replace('/[^A-Za-z0-9 ]/u','', strip_tags($pro->brand));
   ?>
            ...
            <div>
              <br>
            <ul class="product-links product-links--inline" style="margin-top:35px;">
            <?php if($wishlist>=1 ){
                ?>
                 <li><a class=" overlay_img overlay_img_fill" id="<?php echo $pro->id; ?>_<?php echo $pname; ?>"><span class=" icon icon-favorite"></span><span class="added">Added to wishlist</span></a></li>

                <?php
              }else{ ?>

 <?php if($this->session->userdata("userid")==''){
 $url =  base_url().'Welcome/boutique_product/'.$pro->main_category.'/'.$pro->id;
  ?>

  <div class="overlay_img" id="<?php echo $pro->id; ?>_<?php echo $pname; ?>"></div>

 <a href="<?php echo base_url() ?>Welcome/login?url=<?php echo $url ?>"><li><span class="icon icon-favorite"></span  ><span class="added">Add to Wishlist</span></li></a>

  <?php

   }else{
                  ?>
                  <li class="overlay_img" id="<?php echo $pro->id; ?>_<?php echo $pro->brand; ?>" style="margin-left: -206px;"><a href="#"><span class="icon icon-favorite"></span  ><span class="added">Add to Wishlist</span></a></li>
...
?></div>
      ...
      <div class="container">
        ...
        <div class="tab-content tab-content--wd">
          ...
          <div role="tabpanel" class="tab-pane" id="Tab2">
                         ...
                         <?php $review=$this->db->get_where("review",array("p_id"=>$pro->id,"p_name"=>$pro->brand,"status"=>1))->result();
                         if($this->session->userdata("userid")!=""){
                            $review_my=$this->db->get_where("review",array("p_id"=>$pro->id,"p_name"=>$pro->brand,"userid"=>$this->session->userdata('userid')))->result();
                            //print_r($review_my);
                         }

                        $review_count=$this->db->get_where("review",array("p_id"=>$pro->id,"p_name"=>$pro->brand,"status"=>1))->num_rows();
                        ?>
          ...
          <div role="tabpanel" class="tab-pane" id="Tab5">
            ...
            <?php //echo $pro->sizing_guide; ?>
              <img src="<?php echo base_url(); ?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $pro->sizing_guide; ?>" class="sizeimg" >
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container">
        ...
        $this->db->where("main_category",$pro->main_category);
        $this->db->where("id!=",$this->uri->segment(4));
        $this->db->limit(10);
        $rela=$this->db->get_where("online_boutique",array("status"=>'approve',"status_enable"=>'enable'))->result();
        foreach($rela as $rela){

           $catname = $this->db->get_where('mcategory',array('mid'=>$pro->main_category))->row();
       	 $mcatname = $this->db->get_where('main_categories',array('id'=>$pro->category_for_filter))->row();
       	 if(!empty($mcatname)){
       	 $url =  str_replace("--","-",base_url().'online-boutique/'.$catname->mcat_name.'/'.str_replace(" ", "-",$mcatname->name).'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$rela->brand))).'/'.$rela->id);
       	 }else{
       	 $url =  str_replace("--","-",base_url().'online-boutique/'.$catname->mcat_name.'/'.preg_replace('/[^A-Za-z0-9 -]/u','', strip_tags(str_replace(" ", "-",$rela->brand))).'/'.$rela->id);
       	 } ?>
...
<div class="sizes-example sizes-example1">
              <a href="<?php echo $url;?>"><img src="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $rela->thumb;?>" data-lazy="<?php echo base_url();?>assets/images/online_boutique/resized_online_boutique/resize400_600/<?php echo $rela->thumb;?>" alt=""/></a>
</div>
  ...
  if($value1->pid==$pro->id && $value1->pname==$pro->brand)
  {
  //  echo "<br><br>";
  $i++;
  }
  ...
  $review_num=$this->db->get_where("review",array("userid"=>$this->session->userdata("userid"),'p_id'=>$pro->id,'p_name'=>$pro->brand))->row();
  ?>
  ...
  <input type="hidden" name="pid" value="<?php  echo $pro->id; ?>">
            <input type="hidden" name="pname" value="<?php  echo $pro->brand; ?>">
                      ...
                      k(".overlay_img").click(function(){
                       ...
                       // alert(id[0]+"-----"+id[1]);
                        k.ajax({
                         type: "POST",
                         url: '<?php echo base_url();?>index.php/Welcome/wishlist',
                        data: {'pid':id[0],'pname':id[1],'type':'online_boutique'},
                         success: function(response){
   ...
   k("#notifyme").click(function(){
       ...
       // alert(notifyme);
         k.ajax({
           ...
           data: {"value":notifyme,"pid":<?php echo $pro->id; ?>,"pname":"<?php echo $pro->brand; ?>","type":"online_boutique"},
           success: function(response){
            console.log(response);
    ...
    k(".rat_text").hide();
        ...
        //alert(rating);
         k.ajax({
           ...
           data: {"value":rating[1],"pid":<?php echo $pro->id; ?>,"pname":"<?php echo $pro->brand; ?>"},
           success: function(response){
...
$rating = $this->db->get_where('rating',array('p_id'=>$pro->id,'p_name'=>$pro->brand));
 ...
 if(!empty($rat_data) and $rat_num>0)
      ...
      $this->db->update('online_boutique',array('overall_rating'=>$rating2));
...
<?
    $rating = $this->db->get_where('rating',array('p_id'=>$pro->id,'p_name'=>$pro->brand,'users'=>$this->session->userdata("userid")));
      $rat_data =$rating->row();
 if(!empty($rat_data))
      {
