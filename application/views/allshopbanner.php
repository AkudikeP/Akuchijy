                  ...
                  <div class="panel-body table-responsive">
                    <table class="table table-striped" id="data-tables1">
                      ...
                      <tbody>
                        ...
                        <td> 
                          <a class="btn btn-xs btn-warning" href="<?php echo base_url();?>index.php/product/shopbanner/<?php echo $ban->id;?>"><i class="fa fa-edit"></i></a> 
                          <button class="btn btn-xs vd_btn vd_bg-red shopbanner" id="<?php echo $ban->id;?>" type="button"><i class="fa fa-trash-o"></i></button>
                          <?php if($ban->status=='enable'){
                              echo"<button class='btn btn-xs btn-success services_disable' id='$ban->id'><i class='fa fa-lightbulb-o'></i></button>";
                              }else{
                                echo "<button class='btn btn-xs btn-danger services_enable' id='$ban->id'><i class='fa fa-lightbulb-o'></i></button>";
                                } ?>
                                </td>
...
<script>	
					$(document).ready(function(){ 
						$(".del_fabric_banner").click(function(){
							var uid=$(this).attr('id');
							//alert (uid);
							$(this).closest("tr").remove();
							$.ajax({
							 type: "POST",
							 url: '<?php echo base_url();?>index.php/product/del_fabric_banner',
							 data: {sid:uid},
