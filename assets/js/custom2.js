...
jQuery(function(a) {
        ...
        a(".btn-number").click(function(b) {
            ...
            var c = a(this).attr("data-type"),
                ...
                e = parseFloat(d.val());
            isNaN(e) ? d.val(0) : "minus" == c ? (e > d.attr("min") && d.val(e - 0.1).change(), parseFloat(d.val()) == d.attr("min") && a(this).attr("disabled", !0)) : "plus" == c && (e < d.attr("max") && d.val(e + 0.1).change(), parseFloat(d.val()) == d.attr("max") && a(this).attr("disabled", !0))
